...
tasks.register("download-icons") {
    val ghUser = "Remix-Design"
    val ghRepo = "RemixIcon"
    val ghIconsDir = "icons"
    val accessorName = "Remix"
    val applicationIconPackage = "com.woowla.compose.icon.collections.remix"
    val licenseFile = "License"
    val iconsPackName = "Remix icons"
