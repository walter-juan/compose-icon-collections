...
public val DesignGroup.LayoutHorizontalFill: ImageVector
    get() {
        if (_layoutHorizontalFill != null) {
            return _layoutHorizontalFill!!
        }
        _layoutHorizontalFill = Builder(name = "LayoutHorizontalFill", defaultWidth = 24.0.dp,
