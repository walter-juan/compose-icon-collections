...
public val MapGroup.TreasureMapLine: ImageVector
    get() {
        ...
        _treasureMapLine = Builder(name = "TreasureMapLine", defaultWidth = 24.0.dp, defaultHeight =
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                lineTo(17.236f, 9.7f)
                lineTo(18.296f, 10.761f)
                lineTo(17.059f, 11.998f)
                lineTo(18.296f, 13.236f)
                lineTo(17.236f, 14.296f)
                lineTo(15.998f, 13.059f)
                lineTo(14.761f, 14.296f)
                lineTo(13.7f, 13.236f)
                lineTo(14.937f, 11.998f)
                lineTo(13.7f, 10.761f)
                lineTo(14.761f, 9.7f)
                lineTo(15.998f, 10.937f)
                close()
            }
        }
        .build()
