...
public val OthersGroup.UmbrellaLine: ImageVector
    get() {
        ...
        _umbrellaLine = Builder(name = "UmbrellaLine", defaultWidth = 24.0.dp, defaultHeight =
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                close()
                moveTo(19.936f, 11.0f)
                curveTo(19.444f, 7.054f, 16.078f, 4.0f, 11.998f, 4.0f)
                curveTo(7.918f, 4.0f, 4.552f, 7.054f, 4.06f, 11.0f)
                horizontalLineTo(19.936f)
                close()
            }
        }
        .build()
