...
public val MediaGroup.ClapperboardAiFill: ImageVector
    get() {
        if (_clapperboardAiFill != null) {
            return _clapperboardAiFill!!
        }
        _clapperboardAiFill = Builder(name = "ClapperboardAiFill", defaultWidth = 24.0.dp,
