...
public val CommunicationGroup.ChatCheckLine: ImageVector
    get() {
        ...
        _chatCheckLine = Builder(name = "ChatCheckLine", defaultWidth = 24.0.dp, defaultHeight =
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                lineTo(15.535f, 7.879f)
                lineTo(16.95f, 9.293f)
                lineTo(11.293f, 14.95f)
                lineTo(7.404f, 11.061f)
                lineTo(8.818f, 9.646f)
                lineTo(11.293f, 12.121f)
                close()
            }
        }
        .build()
