...
public val FoodGroup.Cake3Line: ImageVector
    get() {
        if (_cake3Line != null) {
            return _cake3Line!!
        }
        _cake3Line = Builder(name = "Cake3Line", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                curveTo(10.921f, 3.0f, 11.794f, 3.208f, 12.574f, 3.579f)
                curveTo(13.198f, 2.628f, 14.276f, 2.0f, 15.5f, 2.0f)
                close()
                moveTo(9.0f, 15.0f)
                ...
                close()
                moveTo(15.5f, 4.0f)
                curveTo(14.954f, 4.0f, 14.476f, 4.292f, 14.213f, 4.729f)
                curveTo(14.726f, 5.234f, 15.148f, 5.831f, 15.453f, 6.493f)
                curveTo(15.897f, 6.265f, 16.384f, 6.109f, 16.899f, 6.04f)
                curveTo(16.965f, 5.873f, 17.0f, 5.69f, 17.0f, 5.5f)
