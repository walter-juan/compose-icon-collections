...
public val LogosGroup.VisaFill: ImageVector
    get() {
        if (_visaFill != null) {
            return _visaFill!!
        }
        _visaFill = Builder(name = "VisaFill", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                lineTo(17.499f, 14.043f)
                lineTo(17.19f, 14.907f)
                lineTo(15.627f, 14.91f)
                curveTo(16.632f, 12.504f, 17.377f, 10.721f, 17.863f, 9.562f)
                curveTo(17.99f, 9.259f, 18.216f, 9.105f, 18.548f, 9.107f)
                curveTo(18.802f, 9.109f, 19.217f, 9.109f, 19.793f, 9.108f)
                lineTo(21.0f, 14.911f)
                lineTo(19.622f, 14.914f)
                close()
                moveTo(17.938f, 12.852f)
                horizontalLineTo(19.194f)
                lineTo(18.725f, 10.672f)
                ...
                curveTo(4.888f, 12.842f, 4.493f, 11.307f, 4.241f, 10.308f)
                curveTo(4.164f, 10.001f, 4.01f, 9.787f, 3.715f, 9.686f)
                curveTo(3.452f, 9.596f, 3.014f, 9.456f, 2.4f, 9.267f)
                verticalLineTo(9.108f)
                curveTo(3.547f, 9.108f, 4.383f, 9.108f, 4.909f, 9.108f)
                curveTo(5.343f, 9.108f, 5.596f, 9.317f, 5.678f, 9.747f)
                curveTo(5.759f, 10.178f, 5.966f, 11.274f, 6.297f, 13.036f)
                lineTo(7.872f, 9.106f)
                close()
                moveTo(11.599f, 9.108f)
                lineTo(10.359f, 14.913f)
                lineTo(8.864f, 14.911f)
                curveTo(8.894f, 14.77f, 9.307f, 12.835f, 10.103f, 9.106f)
                ...
                curveTo(15.596f, 12.173f, 15.694f, 12.603f, 15.684f, 13.071f)
                curveTo(15.674f, 14.042f, 14.853f, 15.0f, 13.12f, 15.0f)
                curveTo(12.329f, 14.988f, 12.044f, 14.922f, 11.399f, 14.694f)
                ...
                curveTo(12.818f, 12.212f, 12.009f, 11.773f, 12.02f, 10.889f)
                curveTo(12.033f, 9.758f, 13.107f, 9.0f, 14.631f, 9.0f)
                close()
            }
        }
        .build()
