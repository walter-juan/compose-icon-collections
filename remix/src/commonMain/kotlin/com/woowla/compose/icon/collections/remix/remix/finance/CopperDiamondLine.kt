...
public val FinanceGroup.CopperDiamondLine: ImageVector
    get() {
        ...
        _copperDiamondLine = Builder(name = "CopperDiamondLine", defaultWidth = 24.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                close()
                moveTo(9.005f, 8.003f)
                horizontalLineTo(15.005f)
                lineTo(17.505f, 11.503f)
                lineTo(12.004f, 17.003f)
                lineTo(6.505f, 11.503f)
                lineTo(9.005f, 8.003f)
                close()
                moveTo(10.035f, 10.003f)
                lineTo(9.115f, 11.293f)
                lineTo(12.004f, 14.183f)
                lineTo(14.895f, 11.293f)
                lineTo(13.975f, 10.003f)
