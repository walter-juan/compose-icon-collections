...
public val OthersGroup.ScalesLine: ImageVector
    get() {
        if (_scalesLine != null) {
            return _scalesLine!!
        }
        _scalesLine = Builder(name = "ScalesLine", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                curveTo(2.998f, 13.105f, 3.893f, 14.0f, 4.998f, 14.0f)
                curveTo(6.103f, 14.0f, 6.998f, 13.105f, 6.998f, 12.0f)
                ...
                curveTo(16.998f, 13.105f, 17.893f, 14.0f, 18.998f, 14.0f)
                curveTo(20.103f, 14.0f, 20.998f, 13.105f, 20.998f, 12.0f)
