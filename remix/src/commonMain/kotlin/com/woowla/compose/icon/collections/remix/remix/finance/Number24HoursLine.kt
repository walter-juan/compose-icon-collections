...
public val FinanceGroup.Number24HoursLine: ImageVector
    get() {
        if (_number24HoursLine != null) {
            return _number24HoursLine!!
        }
        _number24HoursLine = Builder(name = "Number24HoursLine", defaultWidth = 24.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                curveTo(9.255f, 4.003f, 6.829f, 5.39f, 5.389f, 7.503f)
                lineTo(8.005f, 7.503f)
                verticalLineTo(9.503f)
                horizontalLineTo(2.005f)
                verticalLineTo(3.503f)
                horizontalLineTo(4.005f)
                lineTo(4.005f, 6.002f)
                curveTo(5.829f, 3.574f, 8.734f, 2.003f, 12.005f, 2.003f)
                close()
            }
        }
        .build()
...
private var _number24HoursLine: ImageVector? = null
