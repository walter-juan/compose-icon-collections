...
public val MediaGroup.VideoAiFill: ImageVector
    get() {
        if (_videoAiFill != null) {
            return _videoAiFill!!
        }
        _videoAiFill = Builder(name = "VideoAiFill", defaultWidth = 24.0.dp, defaultHeight =
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                close()
                moveTo(19.0f, 11.0f)
                curveTo(19.701f, 11.0f, 20.374f, 10.88f, 21.0f, 10.659f)
                ...
                curveTo(13.12f, 3.626f, 13.0f, 4.299f, 13.0f, 5.0f)
                curveTo(13.0f, 8.314f, 15.686f, 11.0f, 19.0f, 11.0f)
                close()
