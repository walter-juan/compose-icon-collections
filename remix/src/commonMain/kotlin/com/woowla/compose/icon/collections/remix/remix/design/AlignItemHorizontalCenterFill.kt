...
public val DesignGroup.AlignItemHorizontalCenterFill: ImageVector
    get() {
        if (_alignItemHorizontalCenterFill != null) {
            return _alignItemHorizontalCenterFill!!
        }
        _alignItemHorizontalCenterFill = Builder(name = "AlignItemHorizontalCenterFill",
