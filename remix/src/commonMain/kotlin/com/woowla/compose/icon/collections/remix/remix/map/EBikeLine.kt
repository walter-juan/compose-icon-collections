...
public val MapGroup.EBikeLine: ImageVector
    get() {
        if (_eBikeLine != null) {
            return _eBikeLine!!
        }
        _eBikeLine = Builder(name = "EBikeLine", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                curveTo(11.252f, 9.0f, 10.552f, 8.795f, 9.953f, 8.437f)
                curveTo(8.212f, 9.219f, 7.0f, 10.968f, 7.0f, 13.0f)
                ...
                verticalLineTo(13.0f)
                curveTo(17.0f, 10.968f, 15.788f, 9.219f, 14.047f, 8.437f)
                close()
                moveTo(12.0f, 14.0f)
