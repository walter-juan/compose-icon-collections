...
public val MediaGroup.ImageCircleFill: ImageVector
    get() {
        if (_imageCircleFill != null) {
            return _imageCircleFill!!
        }
        _imageCircleFill = Builder(name = "ImageCircleFill", defaultWidth = 24.0.dp, defaultHeight =
