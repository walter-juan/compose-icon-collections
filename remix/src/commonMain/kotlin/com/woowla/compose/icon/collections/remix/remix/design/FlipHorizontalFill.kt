...
public val DesignGroup.FlipHorizontalFill: ImageVector
    get() {
        if (_flipHorizontalFill != null) {
            return _flipHorizontalFill!!
        }
        _flipHorizontalFill = Builder(name = "FlipHorizontalFill", defaultWidth = 24.0.dp,
