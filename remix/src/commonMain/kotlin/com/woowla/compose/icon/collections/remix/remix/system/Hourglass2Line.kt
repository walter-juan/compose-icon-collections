...
public val SystemGroup.Hourglass2Line: ImageVector
    get() {
        if (_hourglass2Line != null) {
            return _hourglass2Line!!
        }
        _hourglass2Line = Builder(name = "Hourglass2Line", defaultWidth = 24.0.dp, defaultHeight =
