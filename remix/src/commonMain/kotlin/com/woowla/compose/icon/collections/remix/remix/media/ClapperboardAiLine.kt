...
public val MediaGroup.ClapperboardAiLine: ImageVector
    get() {
        if (_clapperboardAiLine != null) {
            return _clapperboardAiLine!!
        }
        _clapperboardAiLine = Builder(name = "ClapperboardAiLine", defaultWidth = 24.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                curveTo(14.0f, 5.701f, 14.12f, 6.374f, 14.341f, 7.0f)
                ...
                curveTo(2.455f, 3.0f, 2.0f, 3.445f, 2.0f, 3.993f)
                verticalLineTo(20.007f)
                curveTo(2.0f, 20.555f, 2.444f, 21.0f, 2.992f, 21.0f)
                horizontalLineTo(21.008f)
                curveTo(21.545f, 21.0f, 22.0f, 20.555f, 22.0f, 20.007f)
                verticalLineTo(11.0f)
                horizontalLineTo(20.0f)
                close()
                moveTo(8.307f, 3.0f)
                lineTo(5.998f, 7.0f)
                horizontalLineTo(9.689f)
                lineTo(11.998f, 3.0f)
                horizontalLineTo(8.307f)
                close()
            }
        }
        .build()
