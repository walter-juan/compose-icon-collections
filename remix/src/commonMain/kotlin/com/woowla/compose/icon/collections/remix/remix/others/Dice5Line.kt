...
public val OthersGroup.Dice5Line: ImageVector
    get() {
        if (_dice5Line != null) {
            return _dice5Line!!
        }
        _dice5Line = Builder(name = "Dice5Line", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                close()
                moveTo(10.0f, 15.5f)
                curveTo(10.0f, 16.328f, 9.328f, 17.0f, 8.5f, 17.0f)
                curveTo(7.672f, 17.0f, 7.0f, 16.328f, 7.0f, 15.5f)
                curveTo(7.0f, 14.672f, 7.672f, 14.0f, 8.5f, 14.0f)
                curveTo(9.328f, 14.0f, 10.0f, 14.672f, 10.0f, 15.5f)
                close()
                moveTo(8.5f, 10.0f)
                curveTo(9.328f, 10.0f, 10.0f, 9.328f, 10.0f, 8.5f)
                curveTo(10.0f, 7.672f, 9.328f, 7.0f, 8.5f, 7.0f)
                curveTo(7.672f, 7.0f, 7.0f, 7.672f, 7.0f, 8.5f)
                curveTo(7.0f, 9.328f, 7.672f, 10.0f, 8.5f, 10.0f)
                close()
                moveTo(17.0f, 8.5f)
