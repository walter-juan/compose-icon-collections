...
public val DesignGroup.Compasses2Line: ImageVector
    get() {
        ...
        _compasses2Line = Builder(name = "Compasses2Line", defaultWidth = 24.0.dp, defaultHeight =
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                close()
                moveTo(12.0f, 9.997f)
                curveTo(13.105f, 9.997f, 14.0f, 9.101f, 14.0f, 7.997f)
                curveTo(14.0f, 6.892f, 13.105f, 5.997f, 12.0f, 5.997f)
                curveTo(10.896f, 5.997f, 10.0f, 6.892f, 10.0f, 7.997f)
                curveTo(10.0f, 9.101f, 10.896f, 9.997f, 12.0f, 9.997f)
                close()
            }
        }
        .build()
