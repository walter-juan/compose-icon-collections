...
public val UserAndFacesGroup.OpenArmLine: ImageVector
    get() {
        ...
        _openArmLine = Builder(name = "OpenArmLine", defaultWidth = 24.0.dp, defaultHeight =
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                close()
                moveTo(12.0f, 10.0f)
                curveTo(13.657f, 10.0f, 15.0f, 8.657f, 15.0f, 7.0f)
                curveTo(15.0f, 5.343f, 13.657f, 4.0f, 12.0f, 4.0f)
                curveTo(10.344f, 4.0f, 9.0f, 5.343f, 9.0f, 7.0f)
                curveTo(9.0f, 8.657f, 10.344f, 10.0f, 12.0f, 10.0f)
                close()
            }
        }
        .build()
