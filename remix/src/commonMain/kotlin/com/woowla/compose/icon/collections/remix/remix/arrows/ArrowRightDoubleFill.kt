...
public val ArrowsGroup.ArrowRightDoubleFill: ImageVector
    get() {
        if (_arrowRightDoubleFill != null) {
            return _arrowRightDoubleFill!!
        }
        _arrowRightDoubleFill = Builder(name = "ArrowRightDoubleFill", defaultWidth = 24.0.dp,
