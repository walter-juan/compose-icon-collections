...
public val MediaGroup.ForwardEndLine: ImageVector
    get() {
        if (_forwardEndLine != null) {
            return _forwardEndLine!!
        }
        _forwardEndLine = Builder(name = "ForwardEndLine", defaultWidth = 24.0.dp, defaultHeight =
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                close()
                moveTo(13.0f, 16.263f)
                verticalLineTo(7.737f)
                lineTo(19.394f, 12.0f)
                lineTo(13.0f, 16.263f)
                close()
            }
        }
        .build()
