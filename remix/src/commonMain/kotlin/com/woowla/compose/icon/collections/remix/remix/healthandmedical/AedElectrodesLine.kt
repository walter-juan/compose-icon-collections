...
public val HealthAndMedicalGroup.AedElectrodesLine: ImageVector
    get() {
        if (_aedElectrodesLine != null) {
            return _aedElectrodesLine!!
        }
        _aedElectrodesLine = Builder(name = "AedElectrodesLine", defaultWidth = 24.0.dp,
