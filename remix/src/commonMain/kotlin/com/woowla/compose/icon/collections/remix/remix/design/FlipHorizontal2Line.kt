...
public val DesignGroup.FlipHorizontal2Line: ImageVector
    get() {
        if (_flipHorizontal2Line != null) {
            return _flipHorizontal2Line!!
        }
        _flipHorizontal2Line = Builder(name = "FlipHorizontal2Line", defaultWidth = 24.0.dp,
