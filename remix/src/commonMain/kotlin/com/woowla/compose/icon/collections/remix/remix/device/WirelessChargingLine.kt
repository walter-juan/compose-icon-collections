...
public val DeviceGroup.WirelessChargingLine: ImageVector
    get() {
        ...
        _wirelessChargingLine = Builder(name = "WirelessChargingLine", defaultWidth = 24.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                curveTo(2.119f, 17.262f, 1.0f, 14.762f, 1.0f, 12.0f)
                curveTo(1.0f, 9.239f, 2.119f, 6.739f, 3.929f, 4.929f)
                close()
                moveTo(20.071f, 4.929f)
                curveTo(21.881f, 6.739f, 23.0f, 9.239f, 23.0f, 12.0f)
                curveTo(23.0f, 14.762f, 21.881f, 17.262f, 20.071f, 19.071f)
                ...
                curveTo(7.448f, 9.896f, 7.0f, 10.896f, 7.0f, 12.0f)
                curveTo(7.0f, 13.105f, 7.448f, 14.105f, 8.172f, 14.828f)
