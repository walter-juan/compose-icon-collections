...
public val MediaGroup.RewindStartMiniLine: ImageVector
    get() {
        if (_rewindStartMiniLine != null) {
            return _rewindStartMiniLine!!
        }
        _rewindStartMiniLine = Builder(name = "RewindStartMiniLine", defaultWidth = 24.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                close()
                moveTo(16.968f, 12.0f)
                lineTo(20.0f, 9.86f)
                verticalLineTo(14.14f)
                lineTo(16.968f, 12.0f)
                close()
