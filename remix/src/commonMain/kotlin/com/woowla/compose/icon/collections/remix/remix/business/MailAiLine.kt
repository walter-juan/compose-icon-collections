...
public val BusinessGroup.MailAiLine: ImageVector
    get() {
        if (_mailAiLine != null) {
            return _mailAiLine!!
        }
        _mailAiLine = Builder(name = "MailAiLine", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                lineTo(12.0f, 11.662f)
                lineTo(16.398f, 7.753f)
                lineTo(17.727f, 9.247f)
                lineTo(12.0f, 14.338f)
                lineTo(4.0f, 7.227f)
