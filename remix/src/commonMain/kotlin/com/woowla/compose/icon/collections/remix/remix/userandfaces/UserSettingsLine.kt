...
public val UserAndFacesGroup.UserSettingsLine: ImageVector
    get() {
        ...
        _userSettingsLine = Builder(name = "UserSettingsLine", defaultWidth = 24.0.dp, defaultHeight
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                close()
                moveTo(18.0f, 19.5f)
                curveTo(18.828f, 19.5f, 19.5f, 18.828f, 19.5f, 18.0f)
                curveTo(19.5f, 17.172f, 18.828f, 16.5f, 18.0f, 16.5f)
                curveTo(17.172f, 16.5f, 16.5f, 17.172f, 16.5f, 18.0f)
                curveTo(16.5f, 18.828f, 17.172f, 19.5f, 18.0f, 19.5f)
                close()
            }
        }
        .build()
