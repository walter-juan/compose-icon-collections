...
public val DeviceGroup.MobileDownloadLine: ImageVector
    get() {
        if (_mobileDownloadLine != null) {
            return _mobileDownloadLine!!
        }
        _mobileDownloadLine = Builder(name = "MobileDownloadLine", defaultWidth = 24.0.dp,
