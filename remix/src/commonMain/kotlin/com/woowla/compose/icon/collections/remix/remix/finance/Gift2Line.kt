...
public val FinanceGroup.Gift2Line: ImageVector
    get() {
        if (_gift2Line != null) {
            return _gift2Line!!
        }
        _gift2Line = Builder(name = "Gift2Line", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                curveTo(22.005f, 12.555f, 21.557f, 13.003f, 21.005f, 13.003f)
                horizontalLineTo(20.005f)
                verticalLineTo(21.003f)
                curveTo(20.005f, 21.555f, 19.557f, 22.003f, 19.005f, 22.003f)
                horizontalLineTo(5.005f)
                curveTo(4.453f, 22.003f, 4.005f, 21.555f, 4.005f, 21.003f)
                verticalLineTo(13.003f)
                horizontalLineTo(3.005f)
                curveTo(2.453f, 13.003f, 2.005f, 12.555f, 2.005f, 12.003f)
