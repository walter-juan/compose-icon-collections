...
public val FinanceGroup.XrpLine: ImageVector
    get() {
        if (_xrpLine != null) {
            return _xrpLine!!
        }
        _xrpLine = Builder(name = "XrpLine", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
...
private var _xrpLine: ImageVector? = null
