...
public val ArrowsGroup.ArrowLeftDoubleLine: ImageVector
    get() {
        if (_arrowLeftDoubleLine != null) {
            return _arrowLeftDoubleLine!!
        }
        _arrowLeftDoubleLine = Builder(name = "ArrowLeftDoubleLine", defaultWidth = 24.0.dp,
