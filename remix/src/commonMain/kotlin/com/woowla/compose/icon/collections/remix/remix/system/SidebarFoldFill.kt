...
public val SystemGroup.SidebarFoldFill: ImageVector
    get() {
        if (_sidebarFoldFill != null) {
            return _sidebarFoldFill!!
        }
        _sidebarFoldFill = Builder(name = "SidebarFoldFill", defaultWidth = 24.0.dp, defaultHeight =
