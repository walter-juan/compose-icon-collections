...
public val DesignGroup.AlignItemLeftLine: ImageVector
    get() {
        if (_alignItemLeftLine != null) {
            return _alignItemLeftLine!!
        }
        _alignItemLeftLine = Builder(name = "AlignItemLeftLine", defaultWidth = 24.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                close()
                moveTo(7.0f, 5.0f)
                curveTo(7.0f, 4.448f, 7.448f, 4.0f, 8.0f, 4.0f)
