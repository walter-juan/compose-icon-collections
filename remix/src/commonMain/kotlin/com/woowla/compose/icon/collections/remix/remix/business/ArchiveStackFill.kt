...
public val BusinessGroup.ArchiveStackFill: ImageVector
    get() {
        if (_archiveStackFill != null) {
            return _archiveStackFill!!
        }
        _archiveStackFill = Builder(name = "ArchiveStackFill", defaultWidth = 24.0.dp, defaultHeight
