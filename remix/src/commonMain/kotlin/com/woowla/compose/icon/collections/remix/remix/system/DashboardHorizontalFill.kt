...
public val SystemGroup.DashboardHorizontalFill: ImageVector
    get() {
        if (_dashboardHorizontalFill != null) {
            return _dashboardHorizontalFill!!
        }
        _dashboardHorizontalFill = Builder(name = "DashboardHorizontalFill", defaultWidth = 24.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                lineTo(15.0f, 4.0f)
                curveTo(15.0f, 3.448f, 15.448f, 3.0f, 16.0f, 3.0f)
                lineTo(20.0f, 3.0f)
                close()
                moveTo(20.0f, 13.0f)
                ...
                lineTo(8.0f, 13.0f)
                curveTo(8.552f, 13.0f, 9.0f, 13.448f, 9.0f, 14.0f)
                lineTo(9.0f, 20.0f)
                curveTo(9.0f, 20.552f, 8.552f, 21.0f, 8.0f, 21.0f)
                lineTo(4.0f, 21.0f)
