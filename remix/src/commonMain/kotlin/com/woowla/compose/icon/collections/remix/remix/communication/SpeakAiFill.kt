...
public val CommunicationGroup.SpeakAiFill: ImageVector
    get() {
        if (_speakAiFill != null) {
            return _speakAiFill!!
        }
        _speakAiFill = Builder(name = "SpeakAiFill", defaultWidth = 24.0.dp, defaultHeight =
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                curveTo(21.0f, 11.489f, 20.957f, 10.988f, 20.876f, 10.5f)
                lineTo(22.819f, 10.0f)
                curveTo(22.938f, 10.649f, 23.0f, 11.317f, 23.0f, 12.0f)
