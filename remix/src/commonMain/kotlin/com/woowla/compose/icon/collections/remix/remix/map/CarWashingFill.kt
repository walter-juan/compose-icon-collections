...
public val MapGroup.CarWashingFill: ImageVector
    get() {
        ...
        _carWashingFill = Builder(name = "CarWashingFill", defaultWidth = 24.0.dp, defaultHeight =
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                lineTo(4.417f, 8.971f)
                curveTo(4.779f, 8.369f, 5.43f, 8.0f, 6.132f, 8.0f)
                horizontalLineTo(17.868f)
                curveTo(18.57f, 8.0f, 19.221f, 8.369f, 19.583f, 8.971f)
                lineTo(22.0f, 13.0f)
                verticalLineTo(22.0f)
                ...
                lineTo(17.868f, 10.0f)
                horizontalLineTo(6.132f)
                lineTo(4.332f, 13.0f)
                close()
                moveTo(6.5f, 18.0f)
                curveTo(7.328f, 18.0f, 8.0f, 17.328f, 8.0f, 16.5f)
                curveTo(8.0f, 15.672f, 7.328f, 15.0f, 6.5f, 15.0f)
                curveTo(5.672f, 15.0f, 5.0f, 15.672f, 5.0f, 16.5f)
                curveTo(5.0f, 17.328f, 5.672f, 18.0f, 6.5f, 18.0f)
                close()
                moveTo(17.5f, 18.0f)
                curveTo(18.328f, 18.0f, 19.0f, 17.328f, 19.0f, 16.5f)
                curveTo(19.0f, 15.672f, 18.328f, 15.0f, 17.5f, 15.0f)
                curveTo(16.672f, 15.0f, 16.0f, 15.672f, 16.0f, 16.5f)
                curveTo(16.0f, 17.328f, 16.672f, 18.0f, 17.5f, 18.0f)
                close()
