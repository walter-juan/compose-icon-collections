...
public val UserAndFacesGroup.User2Line: ImageVector
    get() {
        if (_user2Line != null) {
            return _user2Line!!
        }
        _user2Line = Builder(name = "User2Line", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                horizontalLineTo(17.659f)
                curveTo(16.942f, 17.973f, 15.168f, 16.447f, 13.0f, 16.083f)
                close()
                moveTo(11.0f, 20.0f)
                verticalLineTo(16.083f)
                curveTo(8.832f, 16.447f, 7.058f, 17.973f, 6.341f, 20.0f)
