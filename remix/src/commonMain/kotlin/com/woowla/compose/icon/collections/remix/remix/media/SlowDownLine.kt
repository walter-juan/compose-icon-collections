...
public val MediaGroup.SlowDownLine: ImageVector
    get() {
        if (_slowDownLine != null) {
            return _slowDownLine!!
        }
        _slowDownLine = Builder(name = "SlowDownLine", defaultWidth = 24.0.dp, defaultHeight =
