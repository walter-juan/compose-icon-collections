...
public val BusinessGroup.IdCardFill: ImageVector
    get() {
        if (_idCardFill != null) {
            return _idCardFill!!
        }
        _idCardFill = Builder(name = "IdCardFill", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                close()
                moveTo(10.5f, 10.0f)
                curveTo(10.5f, 8.619f, 9.381f, 7.5f, 8.0f, 7.5f)
                curveTo(6.619f, 7.5f, 5.5f, 8.619f, 5.5f, 10.0f)
                curveTo(5.5f, 11.381f, 6.619f, 12.5f, 8.0f, 12.5f)
                curveTo(9.381f, 12.5f, 10.5f, 11.381f, 10.5f, 10.0f)
                close()
                moveTo(8.0f, 13.5f)
