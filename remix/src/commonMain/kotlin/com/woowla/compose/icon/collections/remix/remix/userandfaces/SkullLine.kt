...
public val UserAndFacesGroup.SkullLine: ImageVector
    get() {
        if (_skullLine != null) {
            return _skullLine!!
        }
        _skullLine = Builder(name = "SkullLine", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                close()
                moveTo(16.5f, 14.0f)
                curveTo(15.672f, 14.0f, 15.0f, 13.328f, 15.0f, 12.5f)
                curveTo(15.0f, 11.672f, 15.672f, 11.0f, 16.5f, 11.0f)
                curveTo(17.328f, 11.0f, 18.0f, 11.672f, 18.0f, 12.5f)
                curveTo(18.0f, 13.328f, 17.328f, 14.0f, 16.5f, 14.0f)
                close()
            }
        }
        .build()
