...
public val BuildingsGroup.Store2Line: ImageVector
    get() {
        if (_store2Line != null) {
            return _store2Line!!
        }
        _store2Line = Builder(name = "Store2Line", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                curveTo(18.836f, 13.991f, 18.669f, 14.0f, 18.5f, 14.0f)
                curveTo(17.241f, 14.0f, 16.079f, 13.478f, 15.25f, 12.613f)
                curveTo(14.421f, 13.478f, 13.259f, 14.0f, 12.0f, 14.0f)
                curveTo(10.741f, 14.0f, 9.579f, 13.478f, 8.75f, 12.613f)
                curveTo(7.921f, 13.478f, 6.759f, 14.0f, 5.5f, 14.0f)
                curveTo(5.331f, 14.0f, 5.164f, 13.991f, 5.0f, 13.972f)
                verticalLineTo(20.0f)
