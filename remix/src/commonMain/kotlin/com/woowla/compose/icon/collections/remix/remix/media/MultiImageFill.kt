...
public val MediaGroup.MultiImageFill: ImageVector
    get() {
        if (_multiImageFill != null) {
            return _multiImageFill!!
        }
        _multiImageFill = Builder(name = "MultiImageFill", defaultWidth = 24.0.dp, defaultHeight =
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                verticalLineTo(7.0f)
                close()
                moveTo(16.0f, 15.739f)
                verticalLineTo(9.0f)
                horizontalLineTo(4.0f)
                verticalLineTo(18.632f)
                lineTo(11.491f, 11.64f)
                lineTo(16.0f, 15.739f)
                close()
                moveTo(7.0f, 13.5f)
