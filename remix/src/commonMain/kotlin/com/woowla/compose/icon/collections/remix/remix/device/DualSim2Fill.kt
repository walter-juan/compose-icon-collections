...
public val DeviceGroup.DualSim2Fill: ImageVector
    get() {
        ...
        _dualSim2Fill = Builder(name = "DualSim2Fill", defaultWidth = 24.0.dp, defaultHeight =
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                close()
                moveTo(12.0f, 7.5f)
                curveTo(10.402f, 7.5f, 9.096f, 8.749f, 9.005f, 10.324f)
                lineTo(9.0f, 10.5f)
                horizontalLineTo(11.0f)
                curveTo(11.0f, 9.948f, 11.448f, 9.5f, 12.0f, 9.5f)
                curveTo(12.552f, 9.5f, 13.0f, 9.948f, 13.0f, 10.5f)
                curveTo(13.0f, 10.753f, 12.906f, 10.984f, 12.751f, 11.16f)
                lineTo(12.669f, 11.243f)
                lineTo(8.999f, 14.547f)
                lineTo(9.0f, 16.0f)
                horizontalLineTo(15.0f)
                verticalLineTo(14.0f)
                horizontalLineTo(12.595f)
                lineTo(14.007f, 12.729f)
                lineTo(14.001f, 12.72f)
                lineTo(14.009f, 12.728f)
                curveTo(14.618f, 12.179f, 15.0f, 11.384f, 15.0f, 10.5f)
