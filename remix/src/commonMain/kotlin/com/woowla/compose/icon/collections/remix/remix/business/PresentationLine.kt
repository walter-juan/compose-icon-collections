...
public val BusinessGroup.PresentationLine: ImageVector
    get() {
        if (_presentationLine != null) {
            return _presentationLine!!
        }
        _presentationLine = Builder(name = "PresentationLine", defaultWidth = 24.0.dp, defaultHeight
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                curveTo(21.0f, 15.552f, 20.552f, 16.0f, 20.0f, 16.0f)
                horizontalLineTo(16.576f)
                lineTo(19.399f, 22.0f)
                horizontalLineTo(17.189f)
                lineTo(14.365f, 16.0f)
                horizontalLineTo(10.0f)
                verticalLineTo(14.0f)
