...
public val MapGroup.GuideLine: ImageVector
    get() {
        if (_guideLine != null) {
            return _guideLine!!
        }
        _guideLine = Builder(name = "GuideLine", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                close()
                moveTo(5.0f, 19.0f)
                curveTo(5.552f, 19.0f, 6.0f, 18.552f, 6.0f, 18.0f)
                curveTo(6.0f, 17.448f, 5.552f, 17.0f, 5.0f, 17.0f)
                curveTo(4.448f, 17.0f, 4.0f, 17.448f, 4.0f, 18.0f)
                curveTo(4.0f, 18.552f, 4.448f, 19.0f, 5.0f, 19.0f)
                close()
            }
        }
        .build()
