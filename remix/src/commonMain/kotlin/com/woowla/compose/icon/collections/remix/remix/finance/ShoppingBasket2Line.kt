...
public val FinanceGroup.ShoppingBasket2Line: ImageVector
    get() {
        ...
        _shoppingBasket2Line = Builder(name = "ShoppingBasket2Line", defaultWidth = 24.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                close()
                moveTo(18.831f, 11.002f)
                lineTo(5.178f, 11.002f)
                lineTo(5.845f, 19.002f)
                horizontalLineTo(18.164f)
                lineTo(18.831f, 11.002f)
                close()
