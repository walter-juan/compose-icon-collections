...
public val BusinessGroup.PassValidLine: ImageVector
    get() {
        if (_passValidLine != null) {
            return _passValidLine!!
        }
        _passValidLine = Builder(name = "PassValidLine", defaultWidth = 24.0.dp, defaultHeight =
