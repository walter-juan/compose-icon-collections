...
public val DeviceGroup.SignalWifi3Line: ImageVector
    get() {
        ...
        _signalWifi3Line = Builder(name = "SignalWifi3Line", defaultWidth = 24.0.dp, defaultHeight =
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                close()
                moveTo(12.0f, 10.0f)
                curveTo(10.103f, 10.0f, 8.317f, 10.481f, 6.759f, 11.327f)
                lineTo(12.0f, 17.817f)
                lineTo(17.242f, 11.327f)
                curveTo(15.684f, 10.481f, 13.898f, 10.0f, 12.0f, 10.0f)
                close()
                moveTo(12.0f, 5.0f)
