...
public val DeviceGroup.SignalWifi2Line: ImageVector
    get() {
        ...
        _signalWifi2Line = Builder(name = "SignalWifi2Line", defaultWidth = 24.0.dp, defaultHeight =
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                close()
                moveTo(12.0f, 12.0f)
                curveTo(10.58f, 12.0f, 9.236f, 12.329f, 8.042f, 12.915f)
                lineTo(12.0f, 17.817f)
                lineTo(15.959f, 12.915f)
                curveTo(14.764f, 12.329f, 13.421f, 12.0f, 12.0f, 12.0f)
                close()
                moveTo(12.0f, 5.0f)
