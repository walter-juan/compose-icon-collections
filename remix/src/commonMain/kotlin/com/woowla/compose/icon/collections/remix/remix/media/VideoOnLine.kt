...
public val MediaGroup.VideoOnLine: ImageVector
    get() {
        if (_videoOnLine != null) {
            return _videoOnLine!!
        }
        _videoOnLine = Builder(name = "VideoOnLine", defaultWidth = 24.0.dp, defaultHeight =
...
private var _videoOnLine: ImageVector? = null
