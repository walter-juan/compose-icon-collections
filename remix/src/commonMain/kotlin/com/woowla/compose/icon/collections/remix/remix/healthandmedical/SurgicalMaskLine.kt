...
public val HealthAndMedicalGroup.SurgicalMaskLine: ImageVector
    get() {
        ...
        _surgicalMaskLine = Builder(name = "SurgicalMaskLine", defaultWidth = 24.0.dp, defaultHeight
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                curveTo(5.0f, 14.307f, 5.856f, 15.692f, 7.211f, 16.369f)
                lineTo(12.0f, 18.764f)
                lineTo(16.789f, 16.369f)
                curveTo(18.144f, 15.692f, 19.0f, 14.307f, 19.0f, 12.792f)
                verticalLineTo(6.812f)
                lineTo(12.0f, 5.062f)
                close()
                moveTo(3.0f, 9.0f)
