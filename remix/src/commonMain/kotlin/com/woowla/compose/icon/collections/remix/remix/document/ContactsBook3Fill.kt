...
public val DocumentGroup.ContactsBook3Fill: ImageVector
    get() {
        if (_contactsBook3Fill != null) {
            return _contactsBook3Fill!!
        }
        _contactsBook3Fill = Builder(name = "ContactsBook3Fill", defaultWidth = 24.0.dp,
