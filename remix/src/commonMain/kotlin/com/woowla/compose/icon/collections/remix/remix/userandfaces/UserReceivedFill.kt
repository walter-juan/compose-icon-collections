...
public val UserAndFacesGroup.UserReceivedFill: ImageVector
    get() {
        ...
        _userReceivedFill = Builder(name = "UserReceivedFill", defaultWidth = 24.0.dp, defaultHeight
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                horizontalLineTo(23.004f)
                verticalLineTo(19.0f)
                horizontalLineTo(19.418f)
                lineTo(21.247f, 20.828f)
                lineTo(19.833f, 22.243f)
                lineTo(15.59f, 18.0f)
                lineTo(19.833f, 13.757f)
                lineTo(21.247f, 15.172f)
