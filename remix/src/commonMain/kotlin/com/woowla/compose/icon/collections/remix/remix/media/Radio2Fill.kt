...
public val MediaGroup.Radio2Fill: ImageVector
    get() {
        if (_radio2Fill != null) {
            return _radio2Fill!!
        }
        _radio2Fill = Builder(name = "Radio2Fill", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                close()
                moveTo(9.0f, 15.0f)
                curveTo(10.657f, 15.0f, 12.0f, 13.657f, 12.0f, 12.0f)
                curveTo(12.0f, 10.343f, 10.657f, 9.0f, 9.0f, 9.0f)
                curveTo(7.343f, 9.0f, 6.0f, 10.343f, 6.0f, 12.0f)
                curveTo(6.0f, 13.657f, 7.343f, 15.0f, 9.0f, 15.0f)
                close()
                moveTo(14.0f, 9.0f)
