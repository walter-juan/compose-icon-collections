...
public val DesignGroup.AlignItemRightFill: ImageVector
    get() {
        if (_alignItemRightFill != null) {
            return _alignItemRightFill!!
        }
        _alignItemRightFill = Builder(name = "AlignItemRightFill", defaultWidth = 24.0.dp,
