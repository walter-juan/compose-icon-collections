...
public val FinanceGroup.DiamondRingLine: ImageVector
    get() {
        if (_diamondRingLine != null) {
            return _diamondRingLine!!
        }
        _diamondRingLine = Builder(name = "DiamondRingLine", defaultWidth = 24.0.dp, defaultHeight =
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                close()
                moveTo(10.309f, 3.339f)
                lineTo(10.535f, 3.0f)
                horizontalLineTo(13.465f)
                lineTo(13.691f, 3.339f)
                lineTo(12.0f, 4.876f)
                lineTo(10.309f, 3.339f)
                close()
            }
        }
        .build()
