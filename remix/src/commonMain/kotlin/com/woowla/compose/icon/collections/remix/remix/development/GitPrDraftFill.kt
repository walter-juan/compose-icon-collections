...
public val DevelopmentGroup.GitPrDraftFill: ImageVector
    get() {
        if (_gitPrDraftFill != null) {
            return _gitPrDraftFill!!
        }
        _gitPrDraftFill = Builder(name = "GitPrDraftFill", defaultWidth = 24.0.dp, defaultHeight =
