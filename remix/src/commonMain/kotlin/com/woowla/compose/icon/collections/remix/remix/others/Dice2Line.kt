...
public val OthersGroup.Dice2Line: ImageVector
    get() {
        if (_dice2Line != null) {
            return _dice2Line!!
        }
        _dice2Line = Builder(name = "Dice2Line", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                close()
                moveTo(9.0f, 10.5f)
                curveTo(9.828f, 10.5f, 10.5f, 9.828f, 10.5f, 9.0f)
                curveTo(10.5f, 8.172f, 9.828f, 7.5f, 9.0f, 7.5f)
                curveTo(8.172f, 7.5f, 7.5f, 8.172f, 7.5f, 9.0f)
                curveTo(7.5f, 9.828f, 8.172f, 10.5f, 9.0f, 10.5f)
                close()
            }
        }
        .build()
