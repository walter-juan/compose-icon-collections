...
public val OthersGroup.Dice4Line: ImageVector
    get() {
        if (_dice4Line != null) {
            return _dice4Line!!
        }
        _dice4Line = Builder(name = "Dice4Line", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                close()
                moveTo(9.0f, 16.5f)
                curveTo(9.828f, 16.5f, 10.5f, 15.828f, 10.5f, 15.0f)
                curveTo(10.5f, 14.172f, 9.828f, 13.5f, 9.0f, 13.5f)
                curveTo(8.172f, 13.5f, 7.5f, 14.172f, 7.5f, 15.0f)
                curveTo(7.5f, 15.828f, 8.172f, 16.5f, 9.0f, 16.5f)
                close()
                moveTo(10.5f, 9.0f)
                ...
                close()
                moveTo(15.0f, 10.5f)
                curveTo(15.828f, 10.5f, 16.5f, 9.828f, 16.5f, 9.0f)
                curveTo(16.5f, 8.172f, 15.828f, 7.5f, 15.0f, 7.5f)
                curveTo(14.172f, 7.5f, 13.5f, 8.172f, 13.5f, 9.0f)
                curveTo(13.5f, 9.828f, 14.172f, 10.5f, 15.0f, 10.5f)
                close()
            }
        }
        .build()
