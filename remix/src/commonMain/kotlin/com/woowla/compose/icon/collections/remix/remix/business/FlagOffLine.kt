...
public val BusinessGroup.FlagOffLine: ImageVector
    get() {
        if (_flagOffLine != null) {
            return _flagOffLine!!
        }
        _flagOffLine = Builder(name = "FlagOffLine", defaultWidth = 24.0.dp, defaultHeight =
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                close()
                moveTo(14.586f, 16.0f)
                horizontalLineTo(14.236f)
                lineTo(13.886f, 15.3f)
                lineTo(14.586f, 16.0f)
                close()
                moveTo(12.586f, 14.0f)
                horizontalLineTo(5.0f)
