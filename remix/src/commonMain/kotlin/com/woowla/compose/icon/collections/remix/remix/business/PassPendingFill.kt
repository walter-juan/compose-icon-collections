...
public val BusinessGroup.PassPendingFill: ImageVector
    get() {
        if (_passPendingFill != null) {
            return _passPendingFill!!
        }
        _passPendingFill = Builder(name = "PassPendingFill", defaultWidth = 24.0.dp, defaultHeight =
