...
public val DesignGroup.AlignItemTopLine: ImageVector
    get() {
        if (_alignItemTopLine != null) {
            return _alignItemTopLine!!
        }
        _alignItemTopLine = Builder(name = "AlignItemTopLine", defaultWidth = 24.0.dp, defaultHeight
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                lineTo(11.0f, 8.0f)
                curveTo(11.0f, 7.448f, 10.552f, 7.0f, 10.0f, 7.0f)
                lineTo(5.0f, 7.0f)
                close()
            }
        }
