...
public val MediaGroup.PlayReverseMiniLine: ImageVector
    get() {
        if (_playReverseMiniLine != null) {
            return _playReverseMiniLine!!
        }
        _playReverseMiniLine = Builder(name = "PlayReverseMiniLine", defaultWidth = 24.0.dp,
