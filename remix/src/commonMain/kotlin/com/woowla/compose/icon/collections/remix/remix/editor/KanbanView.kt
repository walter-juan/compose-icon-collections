...
public val EditorGroup.KanbanView: ImageVector
    get() {
        if (_kanbanView != null) {
            return _kanbanView!!
        }
        _kanbanView = Builder(name = "KanbanView", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
...
private var _kanbanView: ImageVector? = null
