...
public val MapGroup.SteeringFill: ImageVector
    get() {
        ...
        _steeringFill = Builder(name = "SteeringFill", defaultWidth = 24.0.dp, defaultHeight =
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                curveTo(14.857f, 13.0f, 13.108f, 14.684f, 13.004f, 16.8f)
                lineTo(12.999f, 17.0f)
                verticalLineTo(18.0f)
                horizontalLineTo(10.999f)
                verticalLineTo(17.0f)
                curveTo(10.999f, 14.858f, 9.315f, 13.109f, 7.199f, 13.005f)
                lineTo(6.999f, 13.0f)
