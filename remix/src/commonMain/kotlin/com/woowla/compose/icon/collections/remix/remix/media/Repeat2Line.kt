...
public val MediaGroup.Repeat2Line: ImageVector
    get() {
        ...
        _repeat2Line = Builder(name = "Repeat2Line", defaultWidth = 24.0.dp, defaultHeight =
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                curveTo(8.0f, 22.209f, 7.776f, 22.432f, 7.5f, 22.432f)
                curveTo(7.383f, 22.432f, 7.27f, 22.391f, 7.18f, 22.316f)
                lineTo(3.061f, 18.884f)
                curveTo(2.849f, 18.707f, 2.82f, 18.392f, 2.997f, 18.18f)
                curveTo(3.092f, 18.066f, 3.233f, 18.0f, 3.381f, 18.0f)
                lineTo(18.0f, 18.0f)
                curveTo(19.105f, 18.0f, 20.0f, 17.104f, 20.0f, 16.0f)
                verticalLineTo(8.0f)
