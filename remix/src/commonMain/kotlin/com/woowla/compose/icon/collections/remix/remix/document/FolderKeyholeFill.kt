...
public val DocumentGroup.FolderKeyholeFill: ImageVector
    get() {
        ...
        _folderKeyholeFill = Builder(name = "FolderKeyholeFill", defaultWidth = 24.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                curveTo(10.0f, 11.74f, 10.402f, 12.387f, 11.0f, 12.732f)
                lineTo(11.0f, 17.0f)
                horizontalLineTo(13.0f)
                lineTo(13.001f, 12.732f)
                curveTo(13.598f, 12.386f, 14.0f, 11.74f, 14.0f, 11.0f)
