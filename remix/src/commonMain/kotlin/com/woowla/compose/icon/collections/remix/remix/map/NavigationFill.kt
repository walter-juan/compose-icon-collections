...
public val MapGroup.NavigationFill: ImageVector
    get() {
        ...
        _navigationFill = Builder(name = "NavigationFill", defaultWidth = 24.0.dp, defaultHeight =
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                curveTo(8.452f, 22.097f, 8.151f, 22.198f, 7.904f, 22.074f)
                curveTo(7.779f, 22.011f, 7.686f, 21.899f, 7.647f, 21.764f)
                lineTo(2.261f, 2.912f)
                curveTo(2.185f, 2.646f, 2.338f, 2.369f, 2.604f, 2.293f)
                curveTo(2.701f, 2.266f, 2.804f, 2.268f, 2.899f, 2.3f)
                close()
            }
        }
        .build()
