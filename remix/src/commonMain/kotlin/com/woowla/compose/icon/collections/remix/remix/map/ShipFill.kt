...
public val MapGroup.ShipFill: ImageVector
    get() {
        if (_shipFill != null) {
            return _shipFill!!
        }
        _shipFill = Builder(name = "ShipFill", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                curveTo(18.364f, 18.0f, 16.912f, 17.215f, 16.0f, 16.0f)
                curveTo(15.088f, 17.215f, 13.636f, 18.0f, 12.0f, 18.0f)
                curveTo(10.364f, 18.0f, 8.912f, 17.215f, 8.0f, 16.0f)
                curveTo(7.088f, 17.215f, 5.636f, 18.0f, 4.0f, 18.0f)
                ...
                moveTo(6.0f, 9.8f)
                lineTo(12.0f, 8.0f)
                lineTo(14.754f, 8.826f)
                lineTo(16.563f, 9.369f)
                lineTo(18.0f, 9.8f)
                verticalLineTo(5.0f)
