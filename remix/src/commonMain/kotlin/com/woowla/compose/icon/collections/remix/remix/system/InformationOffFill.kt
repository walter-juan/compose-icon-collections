...
public val SystemGroup.InformationOffFill: ImageVector
    get() {
        if (_informationOffFill != null) {
            return _informationOffFill!!
        }
        _informationOffFill = Builder(name = "InformationOffFill", defaultWidth = 24.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                close()
                moveTo(13.586f, 15.0f)
                horizontalLineTo(13.0f)
                verticalLineTo(14.414f)
                lineTo(13.586f, 15.0f)
                close()
                moveTo(13.5f, 8.0f)
