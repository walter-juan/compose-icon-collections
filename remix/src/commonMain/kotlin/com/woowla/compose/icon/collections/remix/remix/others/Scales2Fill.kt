...
public val OthersGroup.Scales2Fill: ImageVector
    get() {
        ...
        _scales2Fill = Builder(name = "Scales2Fill", defaultWidth = 24.0.dp, defaultHeight =
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                curveTo(9.789f, 11.0f, 7.998f, 12.791f, 7.998f, 15.0f)
                curveTo(7.998f, 17.209f, 9.789f, 19.0f, 11.998f, 19.0f)
                curveTo(14.207f, 19.0f, 15.998f, 17.209f, 15.998f, 15.0f)
                curveTo(15.998f, 14.258f, 15.796f, 13.564f, 15.444f, 12.968f)
                lineTo(12.705f, 15.707f)
                lineTo(12.611f, 15.79f)
                curveTo(12.219f, 16.095f, 11.651f, 16.068f, 11.291f, 15.707f)
                curveTo(10.9f, 15.317f, 10.9f, 14.683f, 11.291f, 14.293f)
                lineTo(14.03f, 11.554f)
                curveTo(13.434f, 11.202f, 12.74f, 11.0f, 11.998f, 11.0f)
                close()
            }
        }
        .build()
