...
public val HealthAndMedicalGroup.SyringeLine: ImageVector
    get() {
        ...
        _syringeLine = Builder(name = "SyringeLine", defaultWidth = 24.0.dp, defaultHeight =
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                lineTo(11.778f, 7.979f)
                lineTo(10.364f, 9.393f)
                lineTo(12.486f, 11.515f)
                lineTo(11.071f, 12.929f)
                lineTo(8.95f, 10.808f)
                lineTo(7.536f, 12.222f)
                lineTo(9.657f, 14.343f)
                lineTo(8.243f, 15.757f)
                lineTo(6.122f, 13.636f)
                lineTo(6.0f, 13.757f)
                verticalLineTo(18.0f)
                horizontalLineTo(10.243f)
                lineTo(16.021f, 12.222f)
                close()
            }
        }
        .build()
