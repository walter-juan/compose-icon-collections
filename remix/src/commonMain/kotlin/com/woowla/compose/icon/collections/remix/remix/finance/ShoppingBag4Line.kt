...
public val FinanceGroup.ShoppingBag4Line: ImageVector
    get() {
        if (_shoppingBag4Line != null) {
            return _shoppingBag4Line!!
        }
        _shoppingBag4Line = Builder(name = "ShoppingBag4Line", defaultWidth = 24.0.dp, defaultHeight
