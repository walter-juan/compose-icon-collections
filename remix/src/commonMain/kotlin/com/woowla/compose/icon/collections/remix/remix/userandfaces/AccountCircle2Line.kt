...
public val UserAndFacesGroup.AccountCircle2Line: ImageVector
    get() {
        if (_accountCircle2Line != null) {
            return _accountCircle2Line!!
        }
        _accountCircle2Line = Builder(name = "AccountCircle2Line", defaultWidth = 24.0.dp,
