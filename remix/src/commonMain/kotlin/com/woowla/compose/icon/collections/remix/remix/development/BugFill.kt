...
public val DevelopmentGroup.BugFill: ImageVector
    get() {
        if (_bugFill != null) {
            return _bugFill!!
        }
        _bugFill = Builder(name = "BugFill", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                curveTo(16.353f, 20.745f, 14.785f, 21.674f, 13.0f, 21.929f)
                verticalLineTo(14.0f)
                horizontalLineTo(11.0f)
                verticalLineTo(21.929f)
                curveTo(9.215f, 21.674f, 7.647f, 20.745f, 6.562f, 19.408f)
