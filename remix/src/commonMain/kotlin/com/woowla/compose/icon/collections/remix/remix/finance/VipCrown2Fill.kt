...
public val FinanceGroup.VipCrown2Fill: ImageVector
    get() {
        ...
        _vipCrown2Fill = Builder(name = "VipCrown2Fill", defaultWidth = 24.0.dp, defaultHeight =
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                lineTo(21.109f, 20.116f)
                curveTo(21.05f, 20.62f, 20.623f, 21.0f, 20.116f, 21.0f)
                horizontalLineTo(3.894f)
                curveTo(3.387f, 21.0f, 2.96f, 20.62f, 2.901f, 20.116f)
                lineTo(1.258f, 6.149f)
                curveTo(1.193f, 5.6f, 1.586f, 5.103f, 2.134f, 5.039f)
                curveTo(2.37f, 5.011f, 2.608f, 5.068f, 2.806f, 5.2f)
                close()
                moveTo(12.005f, 15.0f)
                curveTo(13.11f, 15.0f, 14.005f, 14.104f, 14.005f, 13.0f)
                curveTo(14.005f, 11.895f, 13.11f, 11.0f, 12.005f, 11.0f)
                curveTo(10.901f, 11.0f, 10.005f, 11.895f, 10.005f, 13.0f)
                curveTo(10.005f, 14.104f, 10.901f, 15.0f, 12.005f, 15.0f)
                close()
            }
        }
        .build()
