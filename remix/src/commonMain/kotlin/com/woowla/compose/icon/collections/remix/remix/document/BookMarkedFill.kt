...
public val DocumentGroup.BookMarkedFill: ImageVector
    get() {
        if (_bookMarkedFill != null) {
            return _bookMarkedFill!!
        }
        _bookMarkedFill = Builder(name = "BookMarkedFill", defaultWidth = 24.0.dp, defaultHeight =
