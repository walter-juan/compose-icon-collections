...
public val HealthAndMedicalGroup.MicroscopeLine: ImageVector
    get() {
        ...
        _microscopeLine = Builder(name = "MicroscopeLine", defaultWidth = 24.0.dp, defaultHeight =
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                close()
                moveTo(8.0f, 16.0f)
                curveTo(6.343f, 16.0f, 5.0f, 17.343f, 5.0f, 19.0f)
                curveTo(5.0f, 19.351f, 5.06f, 19.687f, 5.171f, 20.0f)
                horizontalLineTo(10.829f)
                curveTo(10.94f, 19.687f, 11.0f, 19.351f, 11.0f, 19.0f)
                curveTo(11.0f, 17.343f, 9.657f, 16.0f, 8.0f, 16.0f)
                close()
                moveTo(11.464f, 3.268f)
                lineTo(8.866f, 4.768f)
                lineTo(11.616f, 9.531f)
                lineTo(14.214f, 8.031f)
                lineTo(11.464f, 3.268f)
                close()
            }
        }
        .build()
