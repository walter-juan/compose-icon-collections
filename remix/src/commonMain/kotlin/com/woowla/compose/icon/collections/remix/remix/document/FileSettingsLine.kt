...
public val DocumentGroup.FileSettingsLine: ImageVector
    get() {
        ...
        _fileSettingsLine = Builder(name = "FileSettingsLine", defaultWidth = 24.0.dp, defaultHeight
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                curveTo(8.533f, 12.551f, 8.5f, 12.279f, 8.5f, 12.0f)
                curveTo(8.5f, 11.721f, 8.533f, 11.449f, 8.595f, 11.189f)
                lineTo(7.603f, 10.616f)
                lineTo(8.603f, 8.884f)
                lineTo(9.595f, 9.457f)
                curveTo(9.988f, 9.085f, 10.468f, 8.803f, 11.0f, 8.645f)
                verticalLineTo(7.5f)
                horizontalLineTo(13.0f)
                verticalLineTo(8.645f)
                curveTo(13.532f, 8.803f, 14.012f, 9.085f, 14.405f, 9.457f)
                lineTo(15.397f, 8.884f)
                lineTo(16.397f, 10.616f)
                lineTo(15.405f, 11.189f)
                curveTo(15.467f, 11.449f, 15.5f, 11.721f, 15.5f, 12.0f)
                curveTo(15.5f, 12.279f, 15.467f, 12.551f, 15.406f, 12.811f)
                lineTo(16.397f, 13.384f)
                lineTo(15.397f, 15.116f)
                lineTo(14.405f, 14.543f)
                curveTo(14.012f, 14.915f, 13.533f, 15.197f, 13.0f, 15.355f)
                verticalLineTo(16.5f)
                horizontalLineTo(11.0f)
                verticalLineTo(15.355f)
                curveTo(10.468f, 15.197f, 9.988f, 14.915f, 9.595f, 14.543f)
                lineTo(8.603f, 15.116f)
                lineTo(7.603f, 13.384f)
                lineTo(8.595f, 12.811f)
                close()
                moveTo(12.0f, 13.5f)
