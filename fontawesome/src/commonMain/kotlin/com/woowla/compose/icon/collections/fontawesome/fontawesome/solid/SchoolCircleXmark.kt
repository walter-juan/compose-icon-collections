...
public val SolidGroup.SchoolCircleXmark: ImageVector
    get() {
        if (_schoolCircleXmark != null) {
            return _schoolCircleXmark!!
        }
        _schoolCircleXmark = Builder(name = "SchoolCircleXmark", defaultWidth = 640.0.dp,
