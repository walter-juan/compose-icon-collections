    ...
    get() {
        ...
        _gitlab = Builder(name = "Gitlab", defaultWidth = 512.0.dp, defaultHeight = 512.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                curveTo(423.5f, 10.83f, 420.8f, 9.86f, 417.9f, 9.57f)
                curveTo(415.0f, 9.27f, 412.2f, 9.65f, 409.5f, 10.68f)
                ...
                curveTo(99.86f, 9.68f, 96.98f, 9.3f, 94.12f, 9.59f)
                curveTo(91.26f, 9.88f, 88.51f, 10.83f, 86.08f, 12.38f)
                curveTo(82.84f, 14.43f, 80.33f, 17.45f, 78.92f, 21.02f)
                lineTo(9.27f, 202.8f)
                lineTo(8.54f, 204.6f)
                curveTo(-1.48f, 230.8f, -2.72f, 259.6f, 5.02f, 286.6f)
