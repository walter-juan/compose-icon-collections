...
public val SolidGroup.BridgeWater: ImageVector
    get() {
        ...
        _bridgeWater = Builder(name = "BridgeWater", defaultWidth = 576.0.dp, defaultHeight =
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                curveToRelative(-37.3f, 0.0f, -67.6f, 30.2f, -67.6f, 67.6f)
                lineToRelative(0.0f, 124.9f)
                curveToRelative(-12.9f, 0.0f, -25.8f, 3.9f, -36.8f, 11.7f)
                ...
                curveToRelative(-11.1f, -7.8f, -24.0f, -11.7f, -36.9f, -11.7f)
                lineToRelative(0.0f, -124.9f)
                curveTo(96.0f, 190.2f, 65.8f, 160.0f, 28.4f, 160.0f)
                curveTo(12.7f, 160.0f, 0.0f, 147.3f, 0.0f, 131.6f)
                lineTo(0.0f, 96.0f)
                close()
