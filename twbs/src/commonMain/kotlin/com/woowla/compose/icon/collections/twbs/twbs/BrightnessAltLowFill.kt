...
public val Twbs.BrightnessAltLowFill: ImageVector
    get() {
        if (_brightnessAltLowFill != null) {
            return _brightnessAltLowFill!!
        }
        _brightnessAltLowFill = Builder(name = "BrightnessAltLowFill", defaultWidth = 16.0.dp,
...
private var _brightnessAltLowFill: ImageVector? = null
