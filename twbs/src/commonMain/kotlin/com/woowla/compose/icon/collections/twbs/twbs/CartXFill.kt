...
public val Twbs.CartXFill: ImageVector
    get() {
        if (_cartXFill != null) {
            return _cartXFill!!
        }
        _cartXFill = Builder(name = "CartXFill", defaultWidth = 16.0.dp, defaultHeight = 16.0.dp,
...
private var _cartXFill: ImageVector? = null
