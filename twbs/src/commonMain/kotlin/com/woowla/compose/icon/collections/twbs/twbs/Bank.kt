...
public val Twbs.Bank: ImageVector
    get() {
        if (_bank != null) {
            return _bank!!
        }
        _bank = Builder(name = "Bank", defaultWidth = 16.0.dp, defaultHeight = 16.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                arcToRelative(0.5f, 0.5f, 0.0f, false, true, 0.485f, 0.38f)
                lineToRelative(0.5f, 2.0f)
                arcToRelative(0.498f, 0.498f, 0.0f, false, true, -0.485f, 0.62f)
                lineTo(0.5f, 16.0f)
                arcToRelative(0.498f, 0.498f, 0.0f, false, true, -0.485f, -0.62f)
                lineToRelative(0.5f, -2.0f)
