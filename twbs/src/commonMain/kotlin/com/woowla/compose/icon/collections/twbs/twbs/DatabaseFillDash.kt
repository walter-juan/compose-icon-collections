...
public val Twbs.DatabaseFillDash: ImageVector
    get() {
        if (_databaseFillDash != null) {
            return _databaseFillDash!!
        }
        _databaseFillDash = Builder(name = "DatabaseFillDash", defaultWidth = 16.0.dp, defaultHeight
...
private var _databaseFillDash: ImageVector? = null
