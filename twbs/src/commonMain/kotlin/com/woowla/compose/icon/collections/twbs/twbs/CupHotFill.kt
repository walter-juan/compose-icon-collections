...
public val Twbs.CupHotFill: ImageVector
    get() {
        if (_cupHotFill != null) {
            return _cupHotFill!!
        }
        _cupHotFill = Builder(name = "CupHotFill", defaultWidth = 16.0.dp, defaultHeight = 16.0.dp,
...
private var _cupHotFill: ImageVector? = null
