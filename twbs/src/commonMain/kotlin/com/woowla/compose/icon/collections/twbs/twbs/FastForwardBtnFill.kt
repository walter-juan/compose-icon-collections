...
public val Twbs.FastForwardBtnFill: ImageVector
    get() {
        if (_fastForwardBtnFill != null) {
            return _fastForwardBtnFill!!
        }
        _fastForwardBtnFill = Builder(name = "FastForwardBtnFill", defaultWidth = 16.0.dp,
...
private var _fastForwardBtnFill: ImageVector? = null
