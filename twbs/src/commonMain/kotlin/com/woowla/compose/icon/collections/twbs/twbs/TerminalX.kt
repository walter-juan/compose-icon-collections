...
public val Twbs.TerminalX: ImageVector
    get() {
        if (_terminalX != null) {
            return _terminalX!!
        }
        _terminalX = Builder(name = "TerminalX", defaultWidth = 16.0.dp, defaultHeight = 16.0.dp,
...
private var _terminalX: ImageVector? = null
