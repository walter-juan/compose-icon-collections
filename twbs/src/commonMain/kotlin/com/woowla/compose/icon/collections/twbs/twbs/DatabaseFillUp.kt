...
public val Twbs.DatabaseFillUp: ImageVector
    get() {
        if (_databaseFillUp != null) {
            return _databaseFillUp!!
        }
        _databaseFillUp = Builder(name = "DatabaseFillUp", defaultWidth = 16.0.dp, defaultHeight =
...
private var _databaseFillUp: ImageVector? = null
