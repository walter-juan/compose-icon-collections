...
public val Twbs.BrightnessHighFill: ImageVector
    get() {
        if (_brightnessHighFill != null) {
            return _brightnessHighFill!!
        }
        _brightnessHighFill = Builder(name = "BrightnessHighFill", defaultWidth = 16.0.dp,
...
private var _brightnessHighFill: ImageVector? = null
