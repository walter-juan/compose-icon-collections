...
public val Twbs.PersonBoundingBox: ImageVector
    get() {
        if (_personBoundingBox != null) {
            return _personBoundingBox!!
        }
        _personBoundingBox = Builder(name = "PersonBoundingBox", defaultWidth = 16.0.dp,
...
private var _personBoundingBox: ImageVector? = null
