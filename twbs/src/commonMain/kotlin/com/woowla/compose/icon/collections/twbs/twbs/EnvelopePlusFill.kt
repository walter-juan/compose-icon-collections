...
public val Twbs.EnvelopePlusFill: ImageVector
    get() {
        if (_envelopePlusFill != null) {
            return _envelopePlusFill!!
        }
        _envelopePlusFill = Builder(name = "EnvelopePlusFill", defaultWidth = 16.0.dp, defaultHeight
...
private var _envelopePlusFill: ImageVector? = null
