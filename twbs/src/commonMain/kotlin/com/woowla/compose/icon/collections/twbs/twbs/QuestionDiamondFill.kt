...
public val Twbs.QuestionDiamondFill: ImageVector
    get() {
        if (_questionDiamondFill != null) {
            return _questionDiamondFill!!
        }
        _questionDiamondFill = Builder(name = "QuestionDiamondFill", defaultWidth = 16.0.dp,
...
private var _questionDiamondFill: ImageVector? = null
