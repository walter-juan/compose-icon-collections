...
public val Twbs.FileEarmarkMusicFill: ImageVector
    get() {
        if (_fileEarmarkMusicFill != null) {
            return _fileEarmarkMusicFill!!
        }
        _fileEarmarkMusicFill = Builder(name = "FileEarmarkMusicFill", defaultWidth = 16.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                curveTo(5.302f, 13.383f, 5.0f, 12.995f, 5.0f, 12.5f)
...
private var _fileEarmarkMusicFill: ImageVector? = null
