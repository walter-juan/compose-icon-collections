...
public val Twbs.SendDashFill: ImageVector
    get() {
        if (_sendDashFill != null) {
            return _sendDashFill!!
        }
        _sendDashFill = Builder(name = "SendDashFill", defaultWidth = 16.0.dp, defaultHeight =
...
private var _sendDashFill: ImageVector? = null
