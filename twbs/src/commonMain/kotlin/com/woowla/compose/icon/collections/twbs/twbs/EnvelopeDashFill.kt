...
public val Twbs.EnvelopeDashFill: ImageVector
    get() {
        if (_envelopeDashFill != null) {
            return _envelopeDashFill!!
        }
        _envelopeDashFill = Builder(name = "EnvelopeDashFill", defaultWidth = 16.0.dp, defaultHeight
...
private var _envelopeDashFill: ImageVector? = null
