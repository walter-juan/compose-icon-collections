...
public val Twbs.DatabaseFillAdd: ImageVector
    get() {
        if (_databaseFillAdd != null) {
            return _databaseFillAdd!!
        }
        _databaseFillAdd = Builder(name = "DatabaseFillAdd", defaultWidth = 16.0.dp, defaultHeight =
...
private var _databaseFillAdd: ImageVector? = null
