...
public val Twbs.TelephoneInboundFill: ImageVector
    get() {
        if (_telephoneInboundFill != null) {
            return _telephoneInboundFill!!
        }
        _telephoneInboundFill = Builder(name = "TelephoneInboundFill", defaultWidth = 16.0.dp,
...
private var _telephoneInboundFill: ImageVector? = null
