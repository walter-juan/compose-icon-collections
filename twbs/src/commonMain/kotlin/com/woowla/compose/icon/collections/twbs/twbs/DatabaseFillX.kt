...
public val Twbs.DatabaseFillX: ImageVector
    get() {
        if (_databaseFillX != null) {
            return _databaseFillX!!
        }
        _databaseFillX = Builder(name = "DatabaseFillX", defaultWidth = 16.0.dp, defaultHeight =
...
private var _databaseFillX: ImageVector? = null
