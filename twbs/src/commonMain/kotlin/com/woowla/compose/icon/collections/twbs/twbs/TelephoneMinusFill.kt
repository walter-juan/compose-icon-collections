...
public val Twbs.TelephoneMinusFill: ImageVector
    get() {
        if (_telephoneMinusFill != null) {
            return _telephoneMinusFill!!
        }
        _telephoneMinusFill = Builder(name = "TelephoneMinusFill", defaultWidth = 16.0.dp,
...
private var _telephoneMinusFill: ImageVector? = null
