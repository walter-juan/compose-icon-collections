...
public val Twbs.PciCardNetwork: ImageVector
    get() {
        if (_pciCardNetwork != null) {
            return _pciCardNetwork!!
        }
        _pciCardNetwork = Builder(name = "PciCardNetwork", defaultWidth = 16.0.dp, defaultHeight =
