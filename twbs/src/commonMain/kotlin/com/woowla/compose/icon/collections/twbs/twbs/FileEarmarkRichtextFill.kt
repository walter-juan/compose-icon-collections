...
public val Twbs.FileEarmarkRichtextFill: ImageVector
    get() {
        if (_fileEarmarkRichtextFill != null) {
            return _fileEarmarkRichtextFill!!
        }
        _fileEarmarkRichtextFill = Builder(name = "FileEarmarkRichtextFill", defaultWidth = 16.0.dp,
...
private var _fileEarmarkRichtextFill: ImageVector? = null
