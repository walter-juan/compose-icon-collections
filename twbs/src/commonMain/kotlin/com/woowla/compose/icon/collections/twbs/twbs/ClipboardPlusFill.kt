...
public val Twbs.ClipboardPlusFill: ImageVector
    get() {
        if (_clipboardPlusFill != null) {
            return _clipboardPlusFill!!
        }
        _clipboardPlusFill = Builder(name = "ClipboardPlusFill", defaultWidth = 16.0.dp,
...
private var _clipboardPlusFill: ImageVector? = null
