...
public val Twbs.DatabaseUp: ImageVector
    get() {
        if (_databaseUp != null) {
            return _databaseUp!!
        }
        _databaseUp = Builder(name = "DatabaseUp", defaultWidth = 16.0.dp, defaultHeight = 16.0.dp,
...
private var _databaseUp: ImageVector? = null
