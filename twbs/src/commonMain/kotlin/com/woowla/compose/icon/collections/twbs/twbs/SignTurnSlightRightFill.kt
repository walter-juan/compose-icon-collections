...
public val Twbs.SignTurnSlightRightFill: ImageVector
    get() {
        if (_signTurnSlightRightFill != null) {
            return _signTurnSlightRightFill!!
        }
        _signTurnSlightRightFill = Builder(name = "SignTurnSlightRightFill", defaultWidth = 16.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                close()
                moveTo(8.335f, 6.982f)
                lineTo(9.135f, 8.368f)
...
private var _signTurnSlightRightFill: ImageVector? = null
