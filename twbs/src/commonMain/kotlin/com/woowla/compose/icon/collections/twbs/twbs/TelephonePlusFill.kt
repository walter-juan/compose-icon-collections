...
public val Twbs.TelephonePlusFill: ImageVector
    get() {
        if (_telephonePlusFill != null) {
            return _telephonePlusFill!!
        }
        _telephonePlusFill = Builder(name = "TelephonePlusFill", defaultWidth = 16.0.dp,
...
private var _telephonePlusFill: ImageVector? = null
