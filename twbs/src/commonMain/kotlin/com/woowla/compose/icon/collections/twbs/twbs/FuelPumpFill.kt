...
public val Twbs.FuelPumpFill: ImageVector
    get() {
        if (_fuelPumpFill != null) {
            return _fuelPumpFill!!
        }
        _fuelPumpFill = Builder(name = "FuelPumpFill", defaultWidth = 16.0.dp, defaultHeight =
...
private var _fuelPumpFill: ImageVector? = null
