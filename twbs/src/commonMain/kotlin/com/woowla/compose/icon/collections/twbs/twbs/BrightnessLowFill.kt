...
public val Twbs.BrightnessLowFill: ImageVector
    get() {
        if (_brightnessLowFill != null) {
            return _brightnessLowFill!!
        }
        _brightnessLowFill = Builder(name = "BrightnessLowFill", defaultWidth = 16.0.dp,
...
private var _brightnessLowFill: ImageVector? = null
