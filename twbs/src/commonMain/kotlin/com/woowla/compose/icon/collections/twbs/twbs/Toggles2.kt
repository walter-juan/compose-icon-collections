...
public val Twbs.Toggles2: ImageVector
    get() {
        if (_toggles2 != null) {
            return _toggles2!!
        }
        _toggles2 = Builder(name = "Toggles2", defaultWidth = 16.0.dp, defaultHeight = 16.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                reflectiveCurveToRelative(-0.195f, -1.412f, -0.535f, -2.0f)
            }
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                    strokeLineCap = Butt, strokeLineJoin = Miter, strokeLineMiter = 4.0f,
                    pathFillType = NonZero) {
                ...
                moveToRelative(0.535f, -10.0f)
                arcToRelative(4.0f, 4.0f, 0.0f, false, true, -0.409f, -1.0f)
                horizontalLineTo(4.0f)
                arcToRelative(1.0f, 1.0f, 0.0f, false, true, 0.0f, -2.0f)
                horizontalLineToRelative(2.126f)
                quadToRelative(0.138f, -0.534f, 0.41f, -1.0f)
                horizontalLineTo(4.0f)
