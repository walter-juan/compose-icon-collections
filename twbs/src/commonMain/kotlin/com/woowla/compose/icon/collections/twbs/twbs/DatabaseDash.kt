...
public val Twbs.DatabaseDash: ImageVector
    get() {
        if (_databaseDash != null) {
            return _databaseDash!!
        }
        _databaseDash = Builder(name = "DatabaseDash", defaultWidth = 16.0.dp, defaultHeight =
...
private var _databaseDash: ImageVector? = null
