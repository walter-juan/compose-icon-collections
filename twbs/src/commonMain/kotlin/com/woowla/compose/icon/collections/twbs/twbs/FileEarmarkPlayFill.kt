...
public val Twbs.FileEarmarkPlayFill: ImageVector
    get() {
        if (_fileEarmarkPlayFill != null) {
            return _fileEarmarkPlayFill!!
        }
        _fileEarmarkPlayFill = Builder(name = "FileEarmarkPlayFill", defaultWidth = 16.0.dp,
...
private var _fileEarmarkPlayFill: ImageVector? = null
