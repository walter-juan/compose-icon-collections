...
public val Twbs.PersonFillExclamation: ImageVector
    get() {
        if (_personFillExclamation != null) {
            return _personFillExclamation!!
        }
        _personFillExclamation = Builder(name = "PersonFillExclamation", defaultWidth = 16.0.dp,
