...
public val Twbs.HouseDashFill: ImageVector
    get() {
        if (_houseDashFill != null) {
            return _houseDashFill!!
        }
        _houseDashFill = Builder(name = "HouseDashFill", defaultWidth = 16.0.dp, defaultHeight =
...
private var _houseDashFill: ImageVector? = null
