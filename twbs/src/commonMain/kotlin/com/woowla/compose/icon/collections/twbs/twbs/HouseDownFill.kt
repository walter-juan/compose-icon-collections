...
public val Twbs.HouseDownFill: ImageVector
    get() {
        if (_houseDownFill != null) {
            return _houseDownFill!!
        }
        _houseDownFill = Builder(name = "HouseDownFill", defaultWidth = 16.0.dp, defaultHeight =
...
private var _houseDownFill: ImageVector? = null
