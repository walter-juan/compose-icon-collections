...
public val Twbs.DatabaseFillSlash: ImageVector
    get() {
        if (_databaseFillSlash != null) {
            return _databaseFillSlash!!
        }
        _databaseFillSlash = Builder(name = "DatabaseFillSlash", defaultWidth = 16.0.dp,
...
private var _databaseFillSlash: ImageVector? = null
