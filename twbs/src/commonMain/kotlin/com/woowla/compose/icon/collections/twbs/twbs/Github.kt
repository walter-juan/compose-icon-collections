...
public val Twbs.Github: ImageVector
    get() {
        if (_github != null) {
            return _github!!
        }
        _github = Builder(name = "Github", defaultWidth = 16.0.dp, defaultHeight = 16.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                reflectiveCurveToRelative(1.36f, 0.09f, 2.0f, 0.27f)
                ...
                arcTo(8.01f, 8.01f, 0.0f, false, false, 16.0f, 8.0f)
