...
public val Twbs.ShareFill: ImageVector
    get() {
        if (_shareFill != null) {
            return _shareFill!!
        }
        _shareFill = Builder(name = "ShareFill", defaultWidth = 16.0.dp, defaultHeight = 16.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                arcToRelative(2.5f, 2.5f, 0.0f, false, true, 0.0f, 1.504f)
                lineToRelative(6.718f, 3.12f)
