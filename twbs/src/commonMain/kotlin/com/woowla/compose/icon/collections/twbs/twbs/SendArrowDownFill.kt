...
public val Twbs.SendArrowDownFill: ImageVector
    get() {
        if (_sendArrowDownFill != null) {
            return _sendArrowDownFill!!
        }
        _sendArrowDownFill = Builder(name = "SendArrowDownFill", defaultWidth = 16.0.dp,
...
private var _sendArrowDownFill: ImageVector? = null
