...
public val Twbs.SignIntersection: ImageVector
    get() {
        if (_signIntersection != null) {
            return _signIntersection!!
        }
        _signIntersection = Builder(name = "SignIntersection", defaultWidth = 16.0.dp, defaultHeight
