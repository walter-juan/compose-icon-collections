...
public val Twbs.CameraReelsFill: ImageVector
    get() {
        if (_cameraReelsFill != null) {
            return _cameraReelsFill!!
        }
        _cameraReelsFill = Builder(name = "CameraReelsFill", defaultWidth = 16.0.dp, defaultHeight =
...
private var _cameraReelsFill: ImageVector? = null
