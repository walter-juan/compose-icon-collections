...
public val Twbs.SendPlusFill: ImageVector
    get() {
        if (_sendPlusFill != null) {
            return _sendPlusFill!!
        }
        _sendPlusFill = Builder(name = "SendPlusFill", defaultWidth = 16.0.dp, defaultHeight =
...
private var _sendPlusFill: ImageVector? = null
