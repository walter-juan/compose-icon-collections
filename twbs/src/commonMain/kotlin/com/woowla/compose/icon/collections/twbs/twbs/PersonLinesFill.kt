...
public val Twbs.PersonLinesFill: ImageVector
    get() {
        if (_personLinesFill != null) {
            return _personLinesFill!!
        }
        _personLinesFill = Builder(name = "PersonLinesFill", defaultWidth = 16.0.dp, defaultHeight =
...
private var _personLinesFill: ImageVector? = null
