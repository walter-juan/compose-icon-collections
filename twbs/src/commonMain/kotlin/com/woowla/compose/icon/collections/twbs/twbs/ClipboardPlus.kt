...
public val Twbs.ClipboardPlus: ImageVector
    get() {
        if (_clipboardPlus != null) {
            return _clipboardPlus!!
        }
        _clipboardPlus = Builder(name = "ClipboardPlus", defaultWidth = 16.0.dp, defaultHeight =
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                verticalLineTo(7.5f)
                arcTo(0.5f, 0.5f, 0.0f, false, true, 8.0f, 7.0f)
            }
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                    strokeLineCap = Butt, strokeLineJoin = Miter, strokeLineMiter = 4.0f,
