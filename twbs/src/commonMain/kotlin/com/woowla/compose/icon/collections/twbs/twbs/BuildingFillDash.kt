...
public val Twbs.BuildingFillDash: ImageVector
    get() {
        if (_buildingFillDash != null) {
            return _buildingFillDash!!
        }
        _buildingFillDash = Builder(name = "BuildingFillDash", defaultWidth = 16.0.dp, defaultHeight
...
private var _buildingFillDash: ImageVector? = null
