...
public val Twbs.TelephoneInbound: ImageVector
    get() {
        if (_telephoneInbound != null) {
            return _telephoneInbound!!
        }
        _telephoneInbound = Builder(name = "TelephoneInbound", defaultWidth = 16.0.dp, defaultHeight
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                lineTo(15.146f, 0.146f)
                arcToRelative(0.5f, 0.5f, 0.0f, false, true, 0.708f, 0.0f)
                moveToRelative(-12.2f, 1.182f)
...
private var _telephoneInbound: ImageVector? = null
