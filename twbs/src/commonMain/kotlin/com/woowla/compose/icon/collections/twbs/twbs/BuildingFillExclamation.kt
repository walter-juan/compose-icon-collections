...
public val Twbs.BuildingFillExclamation: ImageVector
    get() {
        if (_buildingFillExclamation != null) {
            return _buildingFillExclamation!!
        }
        _buildingFillExclamation = Builder(name = "BuildingFillExclamation", defaultWidth = 16.0.dp,
...
private var _buildingFillExclamation: ImageVector? = null
