...
public val Twbs.MenuButtonWideFill: ImageVector
    get() {
        if (_menuButtonWideFill != null) {
            return _menuButtonWideFill!!
        }
        _menuButtonWideFill = Builder(name = "MenuButtonWideFill", defaultWidth = 16.0.dp,
...
private var _menuButtonWideFill: ImageVector? = null
