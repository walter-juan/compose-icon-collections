...
public val Twbs.TelephoneOutbound: ImageVector
    get() {
        if (_telephoneOutbound != null) {
            return _telephoneOutbound!!
        }
        _telephoneOutbound = Builder(name = "TelephoneOutbound", defaultWidth = 16.0.dp,
...
private var _telephoneOutbound: ImageVector? = null
