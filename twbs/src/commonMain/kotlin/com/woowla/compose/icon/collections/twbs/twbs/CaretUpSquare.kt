...
public val Twbs.CaretUpSquare: ImageVector
    get() {
        if (_caretUpSquare != null) {
            return _caretUpSquare!!
        }
        _caretUpSquare = Builder(name = "CaretUpSquare", defaultWidth = 16.0.dp, defaultHeight =
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                lineToRelative(-4.0f, 4.5f)
                arcToRelative(0.5f, 0.5f, 0.0f, false, false, -0.082f, 0.537f)
            }
        }
        .build()
        return _caretUpSquare!!
