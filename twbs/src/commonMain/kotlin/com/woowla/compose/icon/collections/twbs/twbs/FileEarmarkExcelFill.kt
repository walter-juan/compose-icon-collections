...
public val Twbs.FileEarmarkExcelFill: ImageVector
    get() {
        if (_fileEarmarkExcelFill != null) {
            return _fileEarmarkExcelFill!!
        }
        _fileEarmarkExcelFill = Builder(name = "FileEarmarkExcelFill", defaultWidth = 16.0.dp,
...
private var _fileEarmarkExcelFill: ImageVector? = null
