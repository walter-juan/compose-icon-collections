...
public val Twbs.SendArrowUp: ImageVector
    get() {
        if (_sendArrowUp != null) {
            return _sendArrowUp!!
        }
        _sendArrowUp = Builder(name = "SendArrowUp", defaultWidth = 16.0.dp, defaultHeight =
...
private var _sendArrowUp: ImageVector? = null
