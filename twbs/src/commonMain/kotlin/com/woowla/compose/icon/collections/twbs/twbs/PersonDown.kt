...
public val Twbs.PersonDown: ImageVector
    get() {
        if (_personDown != null) {
            return _personDown!!
        }
        _personDown = Builder(name = "PersonDown", defaultWidth = 16.0.dp, defaultHeight = 16.0.dp,
...
private var _personDown: ImageVector? = null
