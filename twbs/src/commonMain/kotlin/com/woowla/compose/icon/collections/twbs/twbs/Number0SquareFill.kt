...
public val Twbs.Number0SquareFill: ImageVector
    get() {
        if (_number0SquareFill != null) {
            return _number0SquareFill!!
        }
        _number0SquareFill = Builder(name = "Number0SquareFill", defaultWidth = 16.0.dp,
...
private var _number0SquareFill: ImageVector? = null
