...
public val Twbs.DeviceHdd: ImageVector
    get() {
        if (_deviceHdd != null) {
            return _deviceHdd!!
        }
        _deviceHdd = Builder(name = "DeviceHdd", defaultWidth = 16.0.dp, defaultHeight = 16.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                    ...
                    pathFillType = NonZero) {
                moveTo(12.0f, 7.0f)
                arcToRelative(4.0f, 4.0f, 0.0f, false, true, -3.937f, 4.0f)
                ...
                arcToRelative(3.0f, 3.0f, 0.0f, true, false, -3.891f, 2.865f)
