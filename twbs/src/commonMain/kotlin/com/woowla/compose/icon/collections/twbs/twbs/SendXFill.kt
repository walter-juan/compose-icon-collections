...
public val Twbs.SendXFill: ImageVector
    get() {
        if (_sendXFill != null) {
            return _sendXFill!!
        }
        _sendXFill = Builder(name = "SendXFill", defaultWidth = 16.0.dp, defaultHeight = 16.0.dp,
...
private var _sendXFill: ImageVector? = null
