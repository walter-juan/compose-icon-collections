...
public val Twbs.ShieldFillMinus: ImageVector
    get() {
        if (_shieldFillMinus != null) {
            return _shieldFillMinus!!
        }
        _shieldFillMinus = Builder(name = "ShieldFillMinus", defaultWidth = 16.0.dp, defaultHeight =
...
private var _shieldFillMinus: ImageVector? = null
