...
public val Twbs.FileEarmarkPerson: ImageVector
    get() {
        if (_fileEarmarkPerson != null) {
            return _fileEarmarkPerson!!
        }
        _fileEarmarkPerson = Builder(name = "FileEarmarkPerson", defaultWidth = 16.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                reflectiveCurveTo(12.0f, 12.0f, 8.0f, 12.0f)
