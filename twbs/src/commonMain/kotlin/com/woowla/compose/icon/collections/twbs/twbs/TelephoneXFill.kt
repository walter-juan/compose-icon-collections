...
public val Twbs.TelephoneXFill: ImageVector
    get() {
        if (_telephoneXFill != null) {
            return _telephoneXFill!!
        }
        _telephoneXFill = Builder(name = "TelephoneXFill", defaultWidth = 16.0.dp, defaultHeight =
...
private var _telephoneXFill: ImageVector? = null
