...
public val Twbs.ClipboardHeartFill: ImageVector
    get() {
        if (_clipboardHeartFill != null) {
            return _clipboardHeartFill!!
        }
        _clipboardHeartFill = Builder(name = "ClipboardHeartFill", defaultWidth = 16.0.dp,
...
private var _clipboardHeartFill: ImageVector? = null
