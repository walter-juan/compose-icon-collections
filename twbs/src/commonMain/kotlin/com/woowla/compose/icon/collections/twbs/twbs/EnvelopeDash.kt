...
public val Twbs.EnvelopeDash: ImageVector
    get() {
        if (_envelopeDash != null) {
            return _envelopeDash!!
        }
        _envelopeDash = Builder(name = "EnvelopeDash", defaultWidth = 16.0.dp, defaultHeight =
...
private var _envelopeDash: ImageVector? = null
