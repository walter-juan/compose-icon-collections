...
public val Twbs.CapslockFill: ImageVector
    get() {
        if (_capslockFill != null) {
            return _capslockFill!!
        }
        _capslockFill = Builder(name = "CapslockFill", defaultWidth = 16.0.dp, defaultHeight =
...
private var _capslockFill: ImageVector? = null
