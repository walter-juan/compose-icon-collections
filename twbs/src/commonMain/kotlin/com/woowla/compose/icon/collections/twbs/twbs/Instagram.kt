...
public val Twbs.Instagram: ImageVector
    get() {
        if (_instagram != null) {
            return _instagram!!
        }
        _instagram = Builder(name = "Instagram", defaultWidth = 16.0.dp, defaultHeight = 16.0.dp,
                viewportWidth = 16.0f, viewportHeight = 16.0f).apply {
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                    strokeLineCap = Butt, strokeLineJoin = Miter, strokeLineMiter = 4.0f,
                    pathFillType = NonZero) {
                moveTo(8.0f, 0.0f)
                curveTo(5.829f, 0.0f, 5.556f, 0.01f, 4.703f, 0.048f)
                curveTo(3.85f, 0.088f, 3.269f, 0.222f, 2.76f, 0.42f)
                arcToRelative(3.9f, 3.9f, 0.0f, false, false, -1.417f, 0.923f)
                arcTo(3.9f, 3.9f, 0.0f, false, false, 0.42f, 2.76f)
                curveTo(0.222f, 3.268f, 0.087f, 3.85f, 0.048f, 4.7f)
                curveTo(0.01f, 5.555f, 0.0f, 5.827f, 0.0f, 8.001f)
                curveToRelative(0.0f, 2.172f, 0.01f, 2.444f, 0.048f, 3.297f)
                ...
                arcToRelative(2.5f, 2.5f, 0.0f, false, true, -0.599f, 0.919f)
                ...
                arcToRelative(2.5f, 2.5f, 0.0f, false, true, -0.92f, -0.598f)
                arcToRelative(2.5f, 2.5f, 0.0f, false, true, -0.6f, -0.92f)
                ...
                close()
                moveTo(12.271f, 2.77f)
                arcToRelative(0.96f, 0.96f, 0.0f, true, false, 0.0f, 1.92f)
                arcToRelative(0.96f, 0.96f, 0.0f, false, false, 0.0f, -1.92f)
                moveToRelative(-4.27f, 1.122f)
                arcToRelative(4.109f, 4.109f, 0.0f, true, false, 0.0f, 8.217f)
                arcToRelative(4.109f, 4.109f, 0.0f, false, false, 0.0f, -8.217f)
                moveToRelative(0.0f, 1.441f)
                arcToRelative(2.667f, 2.667f, 0.0f, true, true, 0.0f, 5.334f)
                arcToRelative(2.667f, 2.667f, 0.0f, false, true, 0.0f, -5.334f)
            }
        }
        .build()
        return _instagram!!
