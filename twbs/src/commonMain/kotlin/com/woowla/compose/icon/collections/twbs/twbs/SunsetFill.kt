...
public val Twbs.SunsetFill: ImageVector
    get() {
        if (_sunsetFill != null) {
            return _sunsetFill!!
        }
        _sunsetFill = Builder(name = "SunsetFill", defaultWidth = 16.0.dp, defaultHeight = 16.0.dp,
...
private var _sunsetFill: ImageVector? = null
