...
public val Twbs.EnvelopeArrowDownFill: ImageVector
    get() {
        if (_envelopeArrowDownFill != null) {
            return _envelopeArrowDownFill!!
        }
        _envelopeArrowDownFill = Builder(name = "EnvelopeArrowDownFill", defaultWidth = 16.0.dp,
...
private var _envelopeArrowDownFill: ImageVector? = null
