...
public val Twbs.TencentQq: ImageVector
    get() {
        if (_tencentQq != null) {
            return _tencentQq!!
        }
        _tencentQq = Builder(name = "TencentQq", defaultWidth = 16.0.dp, defaultHeight = 16.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                curveToRelative(0.0f, -0.022f, 0.01f, -0.375f, 0.01f, -0.557f)
                curveToRelative(0.0f, -3.07f, -1.45f, -6.156f, -5.015f, -6.156f)
                reflectiveCurveTo(1.708f, 3.092f, 1.708f, 6.162f)
                curveToRelative(0.0f, 0.182f, 0.01f, 0.535f, 0.01f, 0.557f)
                lineToRelative(-0.72f, 1.795f)
                arcToRelative(26.0f, 26.0f, 0.0f, false, false, -0.534f, 1.508f)
                curveToRelative(-0.68f, 2.187f, -0.46f, 3.093f, -0.292f, 3.113f)
                curveToRelative(0.36f, 0.044f, 1.401f, -1.647f, 1.401f, -1.647f)
                curveToRelative(0.0f, 0.979f, 0.504f, 2.256f, 1.594f, 3.179f)
                ...
                curveToRelative(0.0f, 0.0f, 1.041f, 1.69f, 1.401f, 1.647f)
                curveToRelative(0.168f, -0.02f, 0.388f, -0.926f, -0.292f, -3.113f)
                arcToRelative(26.0f, 26.0f, 0.0f, false, false, -0.534f, -1.508f)
                lineToRelative(-0.72f, -1.795f)
                close()
                moveTo(9.773f, 5.53f)
                arcToRelative(0.1f, 0.1f, 0.0f, false, true, -0.009f, 0.096f)
                curveToRelative(-0.109f, 0.159f, -1.554f, 0.943f, -3.033f, 0.943f)
                horizontalLineToRelative(-0.017f)
                curveToRelative(-1.48f, 0.0f, -2.925f, -0.784f, -3.034f, -0.943f)
                arcToRelative(0.1f, 0.1f, 0.0f, false, true, -0.018f, -0.055f)
                quadToRelative(0.0f, -0.022f, 0.01f, -0.04f)
                curveToRelative(0.13f, -0.287f, 1.43f, -0.606f, 3.042f, -0.606f)
                horizontalLineToRelative(0.017f)
                curveToRelative(1.611f, 0.0f, 2.912f, 0.319f, 3.042f, 0.605f)
                ...
                curveToRelative(-0.054f, -0.9f, 0.0f, -1.663f, 0.097f, -2.285f)
            }
        }
        .build()
        return _tencentQq!!
