...
public val Twbs.DatabaseFillExclamation: ImageVector
    get() {
        if (_databaseFillExclamation != null) {
            return _databaseFillExclamation!!
        }
        _databaseFillExclamation = Builder(name = "DatabaseFillExclamation", defaultWidth = 16.0.dp,
