...
public val Twbs.Calendar2Day: ImageVector
    get() {
        if (_calendar2Day != null) {
            return _calendar2Day!!
        }
        _calendar2Day = Builder(name = "Calendar2Day", defaultWidth = 16.0.dp, defaultHeight =
