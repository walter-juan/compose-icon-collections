...
public val Twbs.CloudPlusFill: ImageVector
    get() {
        if (_cloudPlusFill != null) {
            return _cloudPlusFill!!
        }
        _cloudPlusFill = Builder(name = "CloudPlusFill", defaultWidth = 16.0.dp, defaultHeight =
...
private var _cloudPlusFill: ImageVector? = null
