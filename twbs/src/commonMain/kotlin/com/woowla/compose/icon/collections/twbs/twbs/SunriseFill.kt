...
public val Twbs.SunriseFill: ImageVector
    get() {
        if (_sunriseFill != null) {
            return _sunriseFill!!
        }
        _sunriseFill = Builder(name = "SunriseFill", defaultWidth = 16.0.dp, defaultHeight =
...
private var _sunriseFill: ImageVector? = null
