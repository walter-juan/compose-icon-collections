...
public val Twbs.TelephoneForwardFill: ImageVector
    get() {
        if (_telephoneForwardFill != null) {
            return _telephoneForwardFill!!
        }
        _telephoneForwardFill = Builder(name = "TelephoneForwardFill", defaultWidth = 16.0.dp,
...
private var _telephoneForwardFill: ImageVector? = null
