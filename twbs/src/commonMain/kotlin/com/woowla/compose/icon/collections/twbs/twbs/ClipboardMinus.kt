...
public val Twbs.ClipboardMinus: ImageVector
    get() {
        if (_clipboardMinus != null) {
            return _clipboardMinus!!
        }
        _clipboardMinus = Builder(name = "ClipboardMinus", defaultWidth = 16.0.dp, defaultHeight =
                16.0.dp, viewportWidth = 16.0f, viewportHeight = 16.0f).apply {
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                    strokeLineCap = Butt, strokeLineJoin = Miter, strokeLineMiter = 4.0f,
                    pathFillType = EvenOdd) {
                moveTo(5.5f, 9.5f)
                arcTo(0.5f, 0.5f, 0.0f, false, true, 6.0f, 9.0f)
