...
public val Twbs.FileMusicFill: ImageVector
    get() {
        if (_fileMusicFill != null) {
            return _fileMusicFill!!
        }
        _fileMusicFill = Builder(name = "FileMusicFill", defaultWidth = 16.0.dp, defaultHeight =
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                curveTo(5.302f, 12.383f, 5.0f, 11.995f, 5.0f, 11.5f)
