...
public val Twbs.CartPlusFill: ImageVector
    get() {
        if (_cartPlusFill != null) {
            return _cartPlusFill!!
        }
        _cartPlusFill = Builder(name = "CartPlusFill", defaultWidth = 16.0.dp, defaultHeight =
...
private var _cartPlusFill: ImageVector? = null
