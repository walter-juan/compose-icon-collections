...
public val Twbs.Number9SquareFill: ImageVector
    get() {
        if (_number9SquareFill != null) {
            return _number9SquareFill!!
        }
        _number9SquareFill = Builder(name = "Number9SquareFill", defaultWidth = 16.0.dp,
...
private var _number9SquareFill: ImageVector? = null
