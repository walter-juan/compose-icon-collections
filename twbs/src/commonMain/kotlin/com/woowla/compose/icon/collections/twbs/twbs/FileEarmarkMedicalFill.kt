...
public val Twbs.FileEarmarkMedicalFill: ImageVector
    get() {
        if (_fileEarmarkMedicalFill != null) {
            return _fileEarmarkMedicalFill!!
        }
        _fileEarmarkMedicalFill = Builder(name = "FileEarmarkMedicalFill", defaultWidth = 16.0.dp,
...
private var _fileEarmarkMedicalFill: ImageVector? = null
