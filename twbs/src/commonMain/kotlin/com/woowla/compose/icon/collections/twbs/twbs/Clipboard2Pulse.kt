...
public val Twbs.Clipboard2Pulse: ImageVector
    get() {
        if (_clipboard2Pulse != null) {
            return _clipboard2Pulse!!
        }
        _clipboard2Pulse = Builder(name = "Clipboard2Pulse", defaultWidth = 16.0.dp, defaultHeight =
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                arcToRelative(0.5f, 0.5f, 0.0f, false, false, -0.926f, -0.08f)
                lineTo(4.69f, 10.0f)
