...
public val Twbs.Superscript: ImageVector
    get() {
        if (_superscript != null) {
            return _superscript!!
        }
        _superscript = Builder(name = "Superscript", defaultWidth = 16.0.dp, defaultHeight =
                16.0.dp, viewportWidth = 16.0f, viewportHeight = 16.0f).apply {
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                    strokeLineCap = Butt, strokeLineJoin = Miter, strokeLineMiter = 4.0f,
                    pathFillType = NonZero) {
                moveToRelative(4.266f, 12.496f)
                lineToRelative(0.96f, -2.853f)
                lineTo(8.76f, 9.643f)
                lineToRelative(0.96f, 2.853f)
                lineTo(11.0f, 12.496f)
                lineTo(7.62f, 3.0f)
                lineTo(6.38f, 3.0f)
                lineTo(3.0f, 12.496f)
                close()
                moveTo(7.014f, 4.433f)
                lineTo(8.433f, 8.663f)
                horizontalLineToRelative(-2.88f)
                lineToRelative(1.426f, -4.23f)
                close()
                moveTo(12.146f, 2.636f)
                ...
                curveTo(11.565f, 1.0f, 11.0f, 1.8f, 11.0f, 2.576f)
