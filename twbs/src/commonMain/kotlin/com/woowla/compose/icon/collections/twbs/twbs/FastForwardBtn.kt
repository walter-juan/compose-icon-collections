...
public val Twbs.FastForwardBtn: ImageVector
    get() {
        if (_fastForwardBtn != null) {
            return _fastForwardBtn!!
        }
        _fastForwardBtn = Builder(name = "FastForwardBtn", defaultWidth = 16.0.dp, defaultHeight =
                16.0.dp, viewportWidth = 16.0f, viewportHeight = 16.0f).apply {
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                    strokeLineCap = Butt, strokeLineJoin = Miter, strokeLineMiter = 4.0f,
                    pathFillType = NonZero) {
                moveTo(8.79f, 5.093f)
                arcTo(0.5f, 0.5f, 0.0f, false, false, 8.0f, 5.5f)
