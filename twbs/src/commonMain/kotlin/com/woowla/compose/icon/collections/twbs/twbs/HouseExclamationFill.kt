...
public val Twbs.HouseExclamationFill: ImageVector
    get() {
        if (_houseExclamationFill != null) {
            return _houseExclamationFill!!
        }
        _houseExclamationFill = Builder(name = "HouseExclamationFill", defaultWidth = 16.0.dp,
...
private var _houseExclamationFill: ImageVector? = null
