...
public val Twbs.BookmarkXFill: ImageVector
    get() {
        if (_bookmarkXFill != null) {
            return _bookmarkXFill!!
        }
        _bookmarkXFill = Builder(name = "BookmarkXFill", defaultWidth = 16.0.dp, defaultHeight =
...
private var _bookmarkXFill: ImageVector? = null
