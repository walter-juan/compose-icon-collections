...
public val Twbs.FileEarmarkExcel: ImageVector
    get() {
        ...
        _fileEarmarkExcel = Builder(name = "FileEarmarkExcel", defaultWidth = 16.0.dp, defaultHeight
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                moveTo(5.884f, 6.68f)
                arcToRelative(0.5f, 0.5f, 0.0f, true, false, -0.768f, 0.64f)
                lineTo(7.349f, 10.0f)
                lineToRelative(-2.233f, 2.68f)
                arcToRelative(0.5f, 0.5f, 0.0f, false, false, 0.768f, 0.64f)
                lineTo(8.0f, 10.781f)
                lineToRelative(2.116f, 2.54f)
                arcToRelative(0.5f, 0.5f, 0.0f, false, false, 0.768f, -0.641f)
                lineTo(8.651f, 10.0f)
                lineToRelative(2.233f, -2.68f)
                arcToRelative(0.5f, 0.5f, 0.0f, false, false, -0.768f, -0.64f)
                lineTo(8.0f, 9.219f)
