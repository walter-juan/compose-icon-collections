...
public val Twbs.Clipboard2CheckFill: ImageVector
    get() {
        if (_clipboard2CheckFill != null) {
            return _clipboard2CheckFill!!
        }
        _clipboard2CheckFill = Builder(name = "Clipboard2CheckFill", defaultWidth = 16.0.dp,
...
private var _clipboard2CheckFill: ImageVector? = null
