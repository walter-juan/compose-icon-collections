...
public val FilledGroup.Radioactive: ImageVector
    get() {
        ...
        _radioactive = Builder(name = "Radioactive", defaultWidth = 24.0.dp, defaultHeight =
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                arcToRelative(10.0f, 10.0f, 0.0f, false, true, -5.0f, 8.656f)
                arcToRelative(1.0f, 1.0f, 0.0f, false, true, -1.302f, -0.268f)
                lineToRelative(-0.064f, -0.098f)
                lineToRelative(-3.0f, -5.19f)
                arcToRelative(0.995f, 0.995f, 0.0f, false, true, -0.133f, -0.542f)
                ...
                arcToRelative(0.994f, 0.994f, 0.0f, false, true, 0.165f, -0.155f)
                lineToRelative(0.098f, -0.064f)
                arcToRelative(2.0f, 2.0f, 0.0f, false, false, 0.993f, -1.57f)
                lineToRelative(0.007f, -0.163f)
                arcToRelative(1.0f, 1.0f, 0.0f, false, true, 0.883f, -0.994f)
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                    ...
                    pathFillType = NonZero) {
                moveTo(7.0f, 3.344f)
                arcToRelative(10.0f, 10.0f, 0.0f, false, true, 10.0f, 0.0f)
                arcToRelative(1.0f, 1.0f, 0.0f, false, true, 0.418f, 1.262f)
                lineToRelative(-0.052f, 0.104f)
                lineToRelative(-3.0f, 5.19f)
                lineToRelative(-0.064f, 0.098f)
                arcToRelative(0.994f, 0.994f, 0.0f, false, true, -0.155f, 0.165f)
                lineToRelative(-0.089f, 0.067f)
                arcToRelative(1.0f, 1.0f, 0.0f, false, true, -0.195f, 0.102f)
                lineToRelative(-0.105f, 0.034f)
                lineToRelative(-0.107f, 0.022f)
                arcToRelative(1.003f, 1.003f, 0.0f, false, true, -0.547f, -0.07f)
                lineToRelative(-0.104f, -0.052f)
                arcToRelative(2.0f, 2.0f, 0.0f, false, false, -1.842f, -0.082f)
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                arcToRelative(2.0f, 2.0f, 0.0f, false, false, 0.861f, 1.645f)
                ...
                arcToRelative(0.994f, 0.994f, 0.0f, false, true, -0.08f, 0.437f)
