...
public val FilledGroup.ArrowAutofitHeight: ImageVector
    get() {
        ...
        _arrowAutofitHeight = Builder(name = "ArrowAutofitHeight", defaultWidth = 24.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                arcToRelative(3.0f, 3.0f, 0.0f, false, false, 1.59f, 0.515f)
                ...
                arcToRelative(0.514f, 0.514f, 0.0f, false, true, -0.363f, 0.878f)
                lineToRelative(-6.515f, 0.001f)
                arcToRelative(3.0f, 3.0f, 0.0f, false, true, -3.0f, -3.0f)
                verticalLineToRelative(-12.0f)
                arcToRelative(3.0f, 3.0f, 0.0f, false, true, 3.0f, -3.0f)
                horizontalLineToRelative(6.514f)
                arcToRelative(0.515f, 0.515f, 0.0f, false, true, 0.365f, 0.879f)
            }
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                    strokeLineCap = Butt, strokeLineJoin = Miter, strokeLineMiter = 4.0f,
                    pathFillType = NonZero) {
