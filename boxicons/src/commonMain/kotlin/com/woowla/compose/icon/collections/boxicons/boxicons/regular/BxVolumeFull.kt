...
public val RegularGroup.BxVolumeFull: ImageVector
    get() {
        if (_bxVolumeFull != null) {
            return _bxVolumeFull!!
        }
        _bxVolumeFull = Builder(name = "BxVolumeFull", defaultWidth = 24.0.dp, defaultHeight =
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                arcToRelative(1.027f, 1.027f, 0.0f, false, false, 0.38f, -0.116f)
                curveToRelative(0.026f, -0.015f, 0.057f, -0.017f, 0.082f, -0.033f)
                lineTo(12.0f, 5.868f)
...
private var _bxVolumeFull: ImageVector? = null
