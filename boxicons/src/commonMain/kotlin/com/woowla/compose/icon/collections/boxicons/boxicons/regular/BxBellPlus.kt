...
public val RegularGroup.BxBellPlus: ImageVector
    get() {
        if (_bxBellPlus != null) {
            return _bxBellPlus!!
        }
        _bxBellPlus = Builder(name = "BxBellPlus", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
...
private var _bxBellPlus: ImageVector? = null
