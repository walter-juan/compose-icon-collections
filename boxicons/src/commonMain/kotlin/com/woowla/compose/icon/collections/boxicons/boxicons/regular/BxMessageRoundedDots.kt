...
public val RegularGroup.BxMessageRoundedDots: ImageVector
    get() {
        if (_bxMessageRoundedDots != null) {
            return _bxMessageRoundedDots!!
        }
        _bxMessageRoundedDots = Builder(name = "BxMessageRoundedDots", defaultWidth = 24.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                curveToRelative(0.0f, 2.908f, 1.897f, 5.515f, 5.0f, 6.934f)
                lineTo(7.0f, 22.0f)
                lineToRelative(5.34f, -4.004f)
                ...
                curveTo(5.671f, 14.301f, 4.0f, 12.256f, 4.0f, 10.0f)
...
private var _bxMessageRoundedDots: ImageVector? = null
