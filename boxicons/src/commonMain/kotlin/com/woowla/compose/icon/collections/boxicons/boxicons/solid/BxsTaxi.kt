...
public val SolidGroup.BxsTaxi: ImageVector
    get() {
        if (_bxsTaxi != null) {
            return _bxsTaxi!!
        }
        _bxsTaxi = Builder(name = "BxsTaxi", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
...
private var _bxsTaxi: ImageVector? = null
