...
public val RegularGroup.BxVolumeLow: ImageVector
    get() {
        if (_bxVolumeLow != null) {
            return _bxVolumeLow!!
        }
        _bxVolumeLow = Builder(name = "BxVolumeLow", defaultWidth = 24.0.dp, defaultHeight =
...
private var _bxVolumeLow: ImageVector? = null
