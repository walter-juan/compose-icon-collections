...
public val SolidGroup.BxsBellMinus: ImageVector
    get() {
        if (_bxsBellMinus != null) {
            return _bxsBellMinus!!
        }
        _bxsBellMinus = Builder(name = "BxsBellMinus", defaultWidth = 24.0.dp, defaultHeight =
...
private var _bxsBellMinus: ImageVector? = null
