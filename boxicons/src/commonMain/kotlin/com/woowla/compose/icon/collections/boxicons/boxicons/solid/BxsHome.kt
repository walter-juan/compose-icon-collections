...
public val SolidGroup.BxsHome: ImageVector
    get() {
        if (_bxsHome != null) {
            return _bxsHome!!
        }
        _bxsHome = Builder(name = "BxsHome", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
...
private var _bxsHome: ImageVector? = null
