...
public val SolidGroup.BxsMehBlank: ImageVector
    get() {
        if (_bxsMehBlank != null) {
            return _bxsMehBlank!!
        }
        _bxsMehBlank = Builder(name = "BxsMehBlank", defaultWidth = 24.0.dp, defaultHeight =
...
private var _bxsMehBlank: ImageVector? = null
