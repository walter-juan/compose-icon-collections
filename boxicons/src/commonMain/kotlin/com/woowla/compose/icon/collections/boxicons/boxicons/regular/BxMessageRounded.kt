...
public val RegularGroup.BxMessageRounded: ImageVector
    get() {
        if (_bxMessageRounded != null) {
            return _bxMessageRounded!!
        }
        _bxMessageRounded = Builder(name = "BxMessageRounded", defaultWidth = 24.0.dp, defaultHeight
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                curveToRelative(0.0f, 2.908f, 1.898f, 5.516f, 5.0f, 6.934f)
                lineTo(7.0f, 22.0f)
...
private var _bxMessageRounded: ImageVector? = null
