...
public val RegularGroup.BxTired: ImageVector
    get() {
        if (_bxTired != null) {
            return _bxTired!!
        }
        _bxTired = Builder(name = "BxTired", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
...
private var _bxTired: ImageVector? = null
