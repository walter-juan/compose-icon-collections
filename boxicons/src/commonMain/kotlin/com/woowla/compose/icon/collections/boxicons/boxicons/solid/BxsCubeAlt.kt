...
public val SolidGroup.BxsCubeAlt: ImageVector
    get() {
        if (_bxsCubeAlt != null) {
            return _bxsCubeAlt!!
        }
        _bxsCubeAlt = Builder(name = "BxsCubeAlt", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
...
private var _bxsCubeAlt: ImageVector? = null
