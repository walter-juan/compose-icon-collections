...
public val RegularGroup.BxCuboid: ImageVector
    get() {
        if (_bxCuboid != null) {
            return _bxCuboid!!
        }
        _bxCuboid = Builder(name = "BxCuboid", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                close()
                moveTo(8.381f, 4.795f)
                lineToRelative(3.438f, 3.438f)
                lineToRelative(-4.462f, 10.71f)
                lineToRelative(-3.19f, -3.191f)
                lineTo(8.381f, 4.795f)
                close()
...
private var _bxCuboid: ImageVector? = null
