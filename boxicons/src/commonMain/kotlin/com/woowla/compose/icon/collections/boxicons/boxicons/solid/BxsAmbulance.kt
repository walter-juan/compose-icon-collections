...
public val SolidGroup.BxsAmbulance: ImageVector
    get() {
        if (_bxsAmbulance != null) {
            return _bxsAmbulance!!
        }
        _bxsAmbulance = Builder(name = "BxsAmbulance", defaultWidth = 24.0.dp, defaultHeight =
                24.0.dp, viewportWidth = 24.0f, viewportHeight = 24.0f).apply {
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                    strokeLineCap = Butt, strokeLineJoin = Miter, strokeLineMiter = 4.0f,
                    pathFillType = NonZero) {
                moveTo(21.86f, 12.48f)
                lineTo(19.15f, 8.0f)
...
private var _bxsAmbulance: ImageVector? = null
