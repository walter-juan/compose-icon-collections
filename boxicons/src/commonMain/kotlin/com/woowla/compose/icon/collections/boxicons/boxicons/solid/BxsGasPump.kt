...
public val SolidGroup.BxsGasPump: ImageVector
    get() {
        if (_bxsGasPump != null) {
            return _bxsGasPump!!
        }
        _bxsGasPump = Builder(name = "BxsGasPump", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                arcToRelative(2.99f, 2.99f, 0.0f, false, false, -1.394f, 3.062f)
                curveToRelative(0.15f, 0.899f, 0.769f, 1.676f, 1.57f, 2.111f)
                curveToRelative(0.895f, 0.487f, 1.68f, 0.442f, 2.378f, 0.194f)
...
private var _bxsGasPump: ImageVector? = null
