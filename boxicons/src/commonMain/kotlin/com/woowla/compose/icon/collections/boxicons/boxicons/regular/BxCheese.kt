...
public val RegularGroup.BxCheese: ImageVector
    get() {
        if (_bxCheese != null) {
            return _bxCheese!!
        }
        _bxCheese = Builder(name = "BxCheese", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
...
private var _bxCheese: ImageVector? = null
