...
public val RegularGroup.BxBong: ImageVector
    get() {
        if (_bxBong != null) {
            return _bxBong!!
        }
        _bxBong = Builder(name = "BxBong", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                close()
                moveTo(12.0f, 20.0f)
                arcToRelative(5.007f, 5.007f, 0.0f, false, true, -4.898f, -4.0f)
                horizontalLineToRelative(9.797f)
                arcTo(5.009f, 5.009f, 0.0f, false, true, 12.0f, 20.0f)
                close()
            }
        }
        .build()
...
private var _bxBong: ImageVector? = null
