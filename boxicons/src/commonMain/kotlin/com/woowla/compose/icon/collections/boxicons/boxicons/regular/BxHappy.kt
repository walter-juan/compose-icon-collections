...
public val RegularGroup.BxHappy: ImageVector
    get() {
        if (_bxHappy != null) {
            return _bxHappy!!
        }
        _bxHappy = Builder(name = "BxHappy", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
...
private var _bxHappy: ImageVector? = null
