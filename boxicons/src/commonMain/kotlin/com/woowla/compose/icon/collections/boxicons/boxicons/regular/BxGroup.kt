...
public val RegularGroup.BxGroup: ImageVector
    get() {
        if (_bxGroup != null) {
            return _bxGroup!!
        }
        _bxGroup = Builder(name = "BxGroup", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
...
private var _bxGroup: ImageVector? = null
