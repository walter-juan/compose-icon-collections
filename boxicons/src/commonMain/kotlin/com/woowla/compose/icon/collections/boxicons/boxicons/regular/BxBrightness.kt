...
public val RegularGroup.BxBrightness: ImageVector
    get() {
        if (_bxBrightness != null) {
            return _bxBrightness!!
        }
        _bxBrightness = Builder(name = "BxBrightness", defaultWidth = 24.0.dp, defaultHeight =
                24.0.dp, viewportWidth = 24.0f, viewportHeight = 24.0f).apply {
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                    strokeLineCap = Butt, strokeLineJoin = Miter, strokeLineMiter = 4.0f,
                    pathFillType = NonZero) {
                moveTo(19.707f, 9.293f)
                lineTo(19.0f, 8.586f)
                lineTo(19.0f, 6.0f)
...
private var _bxBrightness: ImageVector? = null
