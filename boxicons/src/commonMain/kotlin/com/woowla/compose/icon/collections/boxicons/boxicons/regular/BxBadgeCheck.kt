...
public val RegularGroup.BxBadgeCheck: ImageVector
    get() {
        if (_bxBadgeCheck != null) {
            return _bxBadgeCheck!!
        }
        _bxBadgeCheck = Builder(name = "BxBadgeCheck", defaultWidth = 24.0.dp, defaultHeight =
                24.0.dp, viewportWidth = 24.0f, viewportHeight = 24.0f).apply {
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                    strokeLineCap = Butt, strokeLineJoin = Miter, strokeLineMiter = 4.0f,
                    pathFillType = NonZero) {
                moveTo(4.035f, 15.479f)
                ...
                reflectiveCurveToRelative(0.802f, 2.786f, 2.035f, 3.479f)
                close()
                moveTo(5.477f, 10.076f)
                lineTo(6.579f, 9.783f)
                lineTo(6.145f, 8.73f)
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                    strokeLineCap = Butt, strokeLineJoin = Miter, strokeLineMiter = 4.0f,
                    pathFillType = NonZero) {
                moveToRelative(15.742f, 10.71f)
                lineToRelative(-1.408f, -1.42f)
                lineToRelative(-3.331f, 3.299f)
...
private var _bxBadgeCheck: ImageVector? = null
