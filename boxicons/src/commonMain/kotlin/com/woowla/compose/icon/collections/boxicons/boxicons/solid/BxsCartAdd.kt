...
public val SolidGroup.BxsCartAdd: ImageVector
    get() {
        if (_bxsCartAdd != null) {
            return _bxsCartAdd!!
        }
        _bxsCartAdd = Builder(name = "BxsCartAdd", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
...
private var _bxsCartAdd: ImageVector? = null
