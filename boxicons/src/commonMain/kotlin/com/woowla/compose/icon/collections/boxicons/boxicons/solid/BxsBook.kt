...
public val SolidGroup.BxsBook: ImageVector
    get() {
        if (_bxsBook != null) {
            return _bxsBook!!
        }
        _bxsBook = Builder(name = "BxsBook", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
...
private var _bxsBook: ImageVector? = null
