...
public val HaskellGroup.Original: ImageVector
    get() {
        if (_original != null) {
            return _original!!
        }
        _original = Builder(name = "Original", defaultWidth = 128.0.dp, defaultHeight = 128.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF463B63)), stroke = null, strokeLineWidth = 0.0f,
            ...
            path(fill = SolidColor(Color(0xFF5E5187)), stroke = null, strokeLineWidth = 0.0f,
                    strokeLineCap = Butt, strokeLineJoin = Miter, strokeLineMiter = 4.0f,
                    pathFillType = NonZero) {
                moveTo(30.1f, 110.2f)
                lineTo(60.2f, 65.0f)
            ...
            path(fill = SolidColor(Color(0xFF904F8C)), stroke = null, strokeLineWidth = 0.0f,
                    strokeLineCap = Butt, strokeLineJoin = Miter, strokeLineMiter = 4.0f,
                    pathFillType = NonZero) {
                moveTo(102.9f, 83.8f)
