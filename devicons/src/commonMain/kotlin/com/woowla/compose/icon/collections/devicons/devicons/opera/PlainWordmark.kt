...
public val OperaGroup.PlainWordmark: ImageVector
    get() {
        ...
        _plainWordmark = Builder(name = "PlainWordmark", defaultWidth = 128.0.dp, defaultHeight =
            ...
            path(fill = SolidColor(Color(0xFFff1b2d)), stroke = null, strokeLineWidth = 0.0f,
                ...
                curveToRelative(6.82f, 0.0f, 12.34f, 7.33f, 12.34f, 16.38f)
                ...
                curveToRelative(-4.13f, -3.5f, -9.56f, -5.63f, -15.52f, -5.65f)
                close()
                moveTo(83.08f, 73.5f)
