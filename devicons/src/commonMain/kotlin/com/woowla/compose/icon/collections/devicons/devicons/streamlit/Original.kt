...
public val StreamlitGroup.Original: ImageVector
    get() {
        if (_original != null) {
            return _original!!
        }
        _original = Builder(name = "Original", defaultWidth = 128.0.dp, defaultHeight = 128.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF7d353b)), stroke = null, strokeLineWidth = 0.426657f,
                    strokeLineCap = Butt, strokeLineJoin = Miter, strokeLineMiter = 4.0f,
                    pathFillType = NonZero) {
            ...
            path(fill = SolidColor(Color(0xFFbd4043)), stroke = null, strokeLineWidth = 0.426657f,
                    strokeLineCap = Butt, strokeLineJoin = Miter, strokeLineMiter = 4.0f,
                    pathFillType = NonZero) {
