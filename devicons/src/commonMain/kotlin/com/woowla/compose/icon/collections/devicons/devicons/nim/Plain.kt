...
public val NimGroup.Plain: ImageVector
    get() {
        if (_plain != null) {
            return _plain!!
        }
        _plain = Builder(name = "Plain", defaultWidth = 128.0.dp, defaultHeight = 128.0.dp,
            ...
            path(fill = SolidColor(Color(0xFFffe953)), stroke = null, strokeLineWidth = 0.0f,
                ...
                reflectiveCurveToRelative(-4.91f, 3.87f, -9.91f, 7.73f)
                arcToRelative(70.22f, 70.22f, 0.0f, false, false, -20.7f, 2.97f)
                ...
                curveToRelative(4.86f, 9.81f, 8.13f, 19.62f, 17.02f, 25.52f)
                curveToRelative(14.17f, -22.35f, 79.91f, -20.29f, 94.35f, -0.13f)
                curveToRelative(9.32f, -4.88f, 12.98f, -15.34f, 16.63f, -25.03f)
                curveToRelative(-0.4f, 0.13f, -5.4f, 1.8f, -8.64f, 3.04f)
                ...
                arcToRelative(64.35f, 64.35f, 0.0f, false, true, -20.42f, -17.4f)
                lineToRelative(11.67f, 28.27f)
