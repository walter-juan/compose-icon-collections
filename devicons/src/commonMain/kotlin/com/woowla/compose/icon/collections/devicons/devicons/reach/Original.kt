...
public val ReachGroup.Original: ImageVector
    get() {
        if (_original != null) {
            return _original!!
        }
        _original = Builder(name = "Original", defaultWidth = 128.0.dp, defaultHeight = 128.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF6AC6E7)), stroke = SolidColor(Color(0x00000000)),
            ...
            path(fill = SolidColor(Color(0xFFF45848)), stroke = SolidColor(Color(0x00000000)),
                    strokeLineWidth = 0.0f, strokeLineCap = Butt, strokeLineJoin = Miter,
                    strokeLineMiter = 4.0f, pathFillType = NonZero) {
