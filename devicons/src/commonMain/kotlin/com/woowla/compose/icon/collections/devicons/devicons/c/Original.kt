...
public val CGroup.Original: ImageVector
    get() {
        if (_original != null) {
            return _original!!
        }
        _original = Builder(name = "Original", defaultWidth = 128.0.dp, defaultHeight = 128.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF659AD3)), stroke = null, strokeLineWidth = 0.0f,
                ...
                curveToRelative(0.0f, 1.1f, 0.2f, 2.4f, 1.0f, 3.5f)
                lineToRelative(106.8f, -62.0f)
                curveToRelative(-0.6f, -1.2f, -1.5f, -2.1f, -2.4f, -2.7f)
                close()
            }
            path(fill = SolidColor(Color(0xFF03599C)), stroke = null, strokeLineWidth = 0.0f,
                ...
                curveToRelative(0.0f, -0.9f, -0.1f, -1.9f, -0.6f, -2.8f)
                lineToRelative(-106.6f, 62.0f)
                close()
            }
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                    ...
                    pathFillType = NonZero) {
                moveTo(85.3f, 76.1f)
                curveTo(81.1f, 83.5f, 73.1f, 88.5f, 64.0f, 88.5f)
