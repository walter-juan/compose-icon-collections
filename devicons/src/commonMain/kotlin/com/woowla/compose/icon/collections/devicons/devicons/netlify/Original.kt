...
public val NetlifyGroup.Original: ImageVector
    get() {
        if (_original != null) {
            return _original!!
        }
        _original = Builder(name = "Original", defaultWidth = 128.0.dp, defaultHeight = 128.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF014847)), stroke = null, strokeLineWidth = 0.0f,
                ...
                lineToRelative(-0.73f, 0.73f)
                horizontalLineTo(47.54f)
                lineToRelative(-0.73f, -0.73f)
                verticalLineTo(46.76f)
                lineToRelative(0.73f, -0.73f)
            ...
            path(fill = SolidColor(Color(0xFF05bdba)), stroke = null, strokeLineWidth = 0.0f,
                    strokeLineCap = Butt, strokeLineJoin = Miter, strokeLineMiter = 4.0f,
                    pathFillType = NonZero) {
