...
public val JunitGroup.Plain: ImageVector
    get() {
        if (_plain != null) {
            return _plain!!
        }
        _plain = Builder(name = "Plain", defaultWidth = 128.0.dp, defaultHeight = 128.0.dp,
            ...
            path(fill = SolidColor(Color(0xFFdc514a)), stroke = null, strokeLineWidth = 0.0f,
                ...
                moveTo(61.35f, 0.43f)
                curveTo(46.69f, 0.68f, 32.73f, 5.03f, 20.69f, 16.16f)
                curveToRelative(-26.89f, 24.87f, -27.68f, 67.44f, -1.72f, 93.22f)
                curveToRelative(4.67f, 4.64f, 10.23f, 8.93f, 16.34f, 11.55f)
                lineToRelative(0.01f, -0.03f)
                curveToRelative(34.12f, 17.72f, 77.34f, -1.65f, 89.55f, -37.08f)
                curveToRelative(10.33f, -29.96f, -5.57f, -72.34f, -38.8f, -80.46f)
                verticalLineToRelative(-0.07f)
                curveTo(78.75f, 1.62f, 71.45f, 0.57f, 64.29f, 0.43f)
                verticalLineToRelative(0.0f)
                arcToRelative(81.05f, 81.05f, 0.0f, false, false, -2.94f, -0.0f)
                close()
                moveTo(40.48f, 19.12f)
                horizontalLineToRelative(45.22f)
                verticalLineToRelative(12.0f)
                horizontalLineTo(52.53f)
                lineToRelative(-1.72f, 21.42f)
                curveToRelative(7.36f, -0.58f, 14.19f, -1.88f, 21.55f, -0.15f)
                ...
                curveToRelative(-3.52f, 1.12f, -7.05f, 1.6f, -10.6f, 1.63f)
                ...
                curveToRelative(-4.24f, 0.51f, -9.53f, 2.08f, -12.46f, -2.43f)
                curveToRelative(-1.73f, -2.65f, 0.05f, -9.17f, 0.34f, -12.18f)
                curveToRelative(0.07f, -0.76f, 0.15f, -1.53f, 0.23f, -2.29f)
                curveToRelative(0.75f, -9.33f, 2.0f, -18.75f, 2.0f, -28.09f)
                close()
            }
        }
        .build()
