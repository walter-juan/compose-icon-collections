...
public val OutlineGroup.ClipboardDocumentList: ImageVector
    get() {
        if (_clipboardDocumentList != null) {
            return _clipboardDocumentList!!
        }
        _clipboardDocumentList = Builder(name = "ClipboardDocumentList", defaultWidth = 24.0.dp,
            ...
            path(fill = SolidColor(Color(0x00000000)), stroke = SolidColor(Color(0xFF0F172A)),
                ...
                curveTo(19.243f, 18.75f, 20.25f, 17.743f, 20.25f, 16.5f)
                ...
                curveTo(15.75f, 8.754f, 15.246f, 8.25f, 14.625f, 8.25f)
