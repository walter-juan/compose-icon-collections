...
public val SolidGroup.DocumentMinus: ImageVector
    get() {
        if (_documentMinus != null) {
            return _documentMinus!!
        }
        _documentMinus = Builder(name = "DocumentMinus", defaultWidth = 24.0.dp, defaultHeight =
            ...
            path(fill = SolidColor(Color(0xFF0F172A)), stroke = null, strokeLineWidth = 0.0f,
                ...
                close()
                moveTo(9.75f, 14.25f)
                curveTo(9.336f, 14.25f, 9.0f, 14.586f, 9.0f, 15.0f)
                curveTo(9.0f, 15.414f, 9.336f, 15.75f, 9.75f, 15.75f)
