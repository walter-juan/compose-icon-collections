...
public val SolidGroup.DocumentArrowDown: ImageVector
    get() {
        if (_documentArrowDown != null) {
            return _documentArrowDown!!
        }
        _documentArrowDown = Builder(name = "DocumentArrowDown", defaultWidth = 24.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF0F172A)), stroke = null, strokeLineWidth = 0.0f,
                ...
                curveTo(11.763f, 18.823f, 12.237f, 18.823f, 12.53f, 18.53f)
                lineTo(15.53f, 15.53f)
                curveTo(15.823f, 15.237f, 15.823f, 14.763f, 15.53f, 14.47f)
                curveTo(15.237f, 14.177f, 14.763f, 14.177f, 14.47f, 14.47f)
                lineTo(12.75f, 16.189f)
                lineTo(12.75f, 12.0f)
                curveTo(12.75f, 11.586f, 12.414f, 11.25f, 12.0f, 11.25f)
                curveTo(11.586f, 11.25f, 11.25f, 11.586f, 11.25f, 12.0f)
