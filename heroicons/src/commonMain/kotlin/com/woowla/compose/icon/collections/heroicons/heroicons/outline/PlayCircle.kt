    ...
    get() {
        ...
        _playCircle = Builder(name = "PlayCircle", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
            ...
            path(fill = SolidColor(Color(0x00000000)), stroke = SolidColor(Color(0xFF0F172A)),
                ...
                curveTo(16.167f, 11.815f, 16.167f, 12.185f, 15.91f, 12.328f)
                lineTo(10.307f, 15.441f)
                curveTo(10.057f, 15.579f, 9.75f, 15.399f, 9.75f, 15.113f)
                verticalLineTo(8.887f)
                curveTo(9.75f, 8.601f, 10.057f, 8.421f, 10.307f, 8.56f)
                lineTo(15.91f, 11.672f)
                close()
            }
        }
        .build()
