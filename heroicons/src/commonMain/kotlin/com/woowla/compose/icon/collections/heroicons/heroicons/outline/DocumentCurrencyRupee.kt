...
public val OutlineGroup.DocumentCurrencyRupee: ImageVector
    get() {
        if (_documentCurrencyRupee != null) {
            return _documentCurrencyRupee!!
        }
        _documentCurrencyRupee = Builder(name = "DocumentCurrencyRupee", defaultWidth = 24.0.dp,
            ...
            path(fill = SolidColor(Color(0x00000000)), stroke = SolidColor(Color(0xFF000000)),
                ...
                moveTo(9.75f, 13.875f)
                horizontalLineTo(14.25f)
                moveTo(12.0f, 18.75f)
                lineTo(9.75f, 16.5f)
                horizontalLineTo(10.125f)
                curveTo(11.575f, 16.5f, 12.75f, 15.325f, 12.75f, 13.875f)
                curveTo(12.75f, 12.425f, 11.575f, 11.25f, 10.125f, 11.25f)
