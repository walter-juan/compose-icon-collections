...
public val OutlineGroup.ArchiveBoxXMark: ImageVector
    get() {
        ...
        _archiveBoxXMark = Builder(name = "ArchiveBoxXMark", defaultWidth = 24.0.dp, defaultHeight =
            ...
            path(fill = SolidColor(Color(0x00000000)), stroke = SolidColor(Color(0xFF0F172A)),
                ...
                lineTo(3.75f, 7.5f)
                moveTo(9.75f, 11.625f)
                lineTo(12.0f, 13.875f)
                moveTo(12.0f, 13.875f)
                lineTo(14.25f, 16.125f)
                moveTo(12.0f, 13.875f)
                lineTo(14.25f, 11.625f)
                moveTo(12.0f, 13.875f)
                lineTo(9.75f, 16.125f)
                moveTo(3.375f, 7.5f)
