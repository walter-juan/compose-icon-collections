...
public val OutlineGroup.DocumentCurrencyEuro: ImageVector
    get() {
        if (_documentCurrencyEuro != null) {
            return _documentCurrencyEuro!!
        }
        _documentCurrencyEuro = Builder(name = "DocumentCurrencyEuro", defaultWidth = 24.0.dp,
            ...
            path(fill = SolidColor(Color(0x00000000)), stroke = SolidColor(Color(0xFF000000)),
                ...
                moveTo(8.25f, 13.875f)
                horizontalLineTo(12.75f)
                moveTo(8.25f, 16.125f)
                horizontalLineTo(12.75f)
                moveTo(14.871f, 17.652f)
                curveTo(13.7f, 19.116f, 11.8f, 19.116f, 10.629f, 17.652f)
                curveTo(9.457f, 16.187f, 9.457f, 13.813f, 10.629f, 12.348f)
                curveTo(11.8f, 10.884f, 13.7f, 10.884f, 14.871f, 12.348f)
                moveTo(10.5f, 2.25f)
