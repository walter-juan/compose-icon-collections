...
public val OutlineGroup.VideoCamera: ImageVector
    get() {
        ...
        _videoCamera = Builder(name = "VideoCamera", defaultWidth = 24.0.dp, defaultHeight =
            ...
            path(fill = SolidColor(Color(0x00000000)), stroke = SolidColor(Color(0xFF0F172A)),
                ...
                curveTo(14.743f, 18.75f, 15.75f, 17.743f, 15.75f, 16.5f)
                verticalLineTo(7.5f)
                curveTo(15.75f, 6.257f, 14.743f, 5.25f, 13.5f, 5.25f)
                horizontalLineTo(4.5f)
                curveTo(3.257f, 5.25f, 2.25f, 6.257f, 2.25f, 7.5f)
                verticalLineTo(16.5f)
                curveTo(2.25f, 17.743f, 3.257f, 18.75f, 4.5f, 18.75f)
                close()
            }
        }
        .build()
