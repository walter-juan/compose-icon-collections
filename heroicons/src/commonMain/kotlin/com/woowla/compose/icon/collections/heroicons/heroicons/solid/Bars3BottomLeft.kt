...
public val SolidGroup.Bars3BottomLeft: ImageVector
    get() {
        if (_bars3BottomLeft != null) {
            return _bars3BottomLeft!!
        }
        _bars3BottomLeft = Builder(name = "Bars3BottomLeft", defaultWidth = 24.0.dp, defaultHeight =
            ...
            path(fill = SolidColor(Color(0xFF0F172A)), stroke = null, strokeLineWidth = 0.0f,
                ...
                close()
                moveTo(3.0f, 17.25f)
                curveTo(3.0f, 16.836f, 3.336f, 16.5f, 3.75f, 16.5f)
                horizontalLineTo(12.0f)
                curveTo(12.414f, 16.5f, 12.75f, 16.836f, 12.75f, 17.25f)
                curveTo(12.75f, 17.664f, 12.414f, 18.0f, 12.0f, 18.0f)
                horizontalLineTo(3.75f)
                curveTo(3.336f, 18.0f, 3.0f, 17.664f, 3.0f, 17.25f)
                close()
            }
        }
        .build()
