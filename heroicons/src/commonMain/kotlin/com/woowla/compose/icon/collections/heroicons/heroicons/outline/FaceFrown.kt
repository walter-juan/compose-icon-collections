...
public val OutlineGroup.FaceFrown: ImageVector
    get() {
        if (_faceFrown != null) {
            return _faceFrown!!
        }
        _faceFrown = Builder(name = "FaceFrown", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
            ...
            path(fill = SolidColor(Color(0x00000000)), stroke = SolidColor(Color(0xFF0F172A)),
                ...
                curveTo(14.307f, 15.443f, 13.162f, 15.004f, 12.016f, 15.0f)
                curveTo(10.859f, 14.996f, 9.701f, 15.435f, 8.818f, 16.318f)
                moveTo(21.0f, 12.0f)
