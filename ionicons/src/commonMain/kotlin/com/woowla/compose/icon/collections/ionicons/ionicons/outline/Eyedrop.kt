...
public val OutlineGroup.Eyedrop: ImageVector
    get() {
        if (_eyedrop != null) {
            return _eyedrop!!
        }
        _eyedrop = Builder(name = "Eyedrop", defaultWidth = 512.0.dp, defaultHeight = 512.0.dp,
            ...
            path(fill = SolidColor(Color(0x00000000)), stroke = SolidColor(Color(0xFF000000)),
                ...
                arcTo(32.03f, 32.03f, 134.99f, false, true, 375.72f, 272.15f)
                lineTo(375.72f, 272.15f)
                arcTo(32.03f, 32.03f, 134.99f, false, true, 330.42f, 272.15f)
                lineTo(239.85f, 181.57f)
                arcTo(32.03f, 32.03f, 134.99f, false, true, 239.85f, 136.28f)
                lineTo(239.85f, 136.28f)
                arcTo(32.03f, 32.03f, 134.99f, false, true, 285.14f, 136.28f)
                close()
            }
            path(fill = SolidColor(Color(0x00000000)), stroke = SolidColor(Color(0xFF000000)),
                    strokeLineWidth = 32.0f, strokeLineCap = Round, strokeLineJoin =
