...
public val SharpGroup.Server: ImageVector
    get() {
        if (_server != null) {
            return _server!!
        }
        _server = Builder(name = "Server", defaultWidth = 512.0.dp, defaultHeight = 512.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                curveTo(424.94f, 186.89f, 437.56f, 176.24f, 448.0f, 165.02f)
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                curveTo(87.06f, 330.89f, 74.44f, 320.24f, 64.0f, 309.02f)
                close()
            }
        }
        .build()
